...
# Writing single library: virtuoso-codegen
include $(CLEAR_VARS)
LOCAL_MODULE := virtuoso-codegen
LOCAL_SRC_FILES += $(call rwildcard,./src,*.cpp)
LOCAL_C_INCLUDES := ./include
LOCAL_CFLAGS += -DMOD_ID='"codegen"' -DVERSION='"0.2.5"' -DNEED_UNSAFE_CSHARP -DNO_CODEGEN_USE
LOCAL_CFLAGS += -Wall -Wextra -Werror -Wno-unused-function -isystem'D:\Programs\il2cpp_qpm\il2cpp\libil2cpp' -isystem'extern'
