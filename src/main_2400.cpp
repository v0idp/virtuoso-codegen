...
bool Mono::Math::Prime::PrimalityTest_::Invoke(::Mono::Math::BigInteger_* bi, ::Mono::Math::Prime::ConfidenceFactor_ confidence) {
  ...
  auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::Mono::Math::Prime::PrimalityTest_*), 12));
...
bool Mono::Math::Prime::PrimalityTest_::EndInvoke(::System::IAsyncResult* result) {
  ...
  auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::Mono::Math::Prime::PrimalityTest_*), 14));
