...
namespace Unity::XR::Oculus {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Boundary::BoundaryType), 16 + sizeof(int)> __Unity_XR_Oculus_Boundary_BoundaryTypeSizeCheck;
  static_assert(sizeof(Boundary::BoundaryType) == 0x14);
}
