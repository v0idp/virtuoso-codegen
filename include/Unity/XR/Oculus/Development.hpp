...
namespace Unity::XR::Oculus {
  ...
  class Development : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(Development::UserDeveloperModeSettingCache), 16 + sizeof(int)> __Unity_XR_Oculus_Development_UserDeveloperModeSettingCacheSizeCheck;
    static_assert(sizeof(Development::UserDeveloperModeSettingCache) == 0x14);
