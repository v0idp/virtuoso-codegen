...
namespace Unity::Collections {
  ...
  // [UsedByNativeCodeAttribute] Offset: 564674
  ...
  #pragma pack(pop)
  static check_size<sizeof(Allocator), 16 + sizeof(int)> __Unity_Collections_AllocatorSizeCheck;
  static_assert(sizeof(Allocator) == 0x14);
}
