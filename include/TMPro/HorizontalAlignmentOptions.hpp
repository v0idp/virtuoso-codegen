...
namespace TMPro {
  ...
  #pragma pack(pop)
  static check_size<sizeof(HorizontalAlignmentOptions), 16 + sizeof(int)> __TMPro_HorizontalAlignmentOptionsSizeCheck;
  static_assert(sizeof(HorizontalAlignmentOptions) == 0x14);
}
