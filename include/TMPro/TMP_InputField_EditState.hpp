...
namespace TMPro {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TMP_InputField::EditState), 16 + sizeof(int)> __TMPro_TMP_InputField_EditStateSizeCheck;
  static_assert(sizeof(TMP_InputField::EditState) == 0x14);
}
