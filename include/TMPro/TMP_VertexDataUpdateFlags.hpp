...
namespace TMPro {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TMP_VertexDataUpdateFlags), 16 + sizeof(int)> __TMPro_TMP_VertexDataUpdateFlagsSizeCheck;
  static_assert(sizeof(TMP_VertexDataUpdateFlags) == 0x14);
}
