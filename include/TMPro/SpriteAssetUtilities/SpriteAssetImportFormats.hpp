...
namespace TMPro::SpriteAssetUtilities {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SpriteAssetImportFormats), 16 + sizeof(int)> __TMPro_SpriteAssetUtilities_SpriteAssetImportFormatsSizeCheck;
  static_assert(sizeof(SpriteAssetImportFormats) == 0x14);
}
