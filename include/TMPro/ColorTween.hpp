...
namespace TMPro {
  ...
  struct ColorTween/*, public ::System::ValueType, public ::TMPro::ITweenValue*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(ColorTween::ColorTweenMode), 16 + sizeof(int)> __TMPro_ColorTween_ColorTweenModeSizeCheck;
    ...
    // Field size check
    static_assert(sizeof(::TMPro::ColorTween::ColorTweenMode) == 0x14);
