...
namespace Firebase::Platform {
  ...
  class MainThreadProperty_1 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::System::Func_1<T>*& dyn_getPropertyDelegate() {
    ...
    [[deprecated("Use field access instead!")]] int& dyn_lastGetPropertyTickCount() {
    ...
    [[deprecated("Use field access instead!")]] T& dyn_cachedValue() {
