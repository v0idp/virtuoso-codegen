...
namespace Firebase {
  ...
  class Dispatcher::$Run$c__AnonStorey0_1 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::Firebase::Dispatcher::CallbackStorage_1<TResult>*& dyn_result() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Threading::EventWaitHandle*& dyn_waitHandle() {
