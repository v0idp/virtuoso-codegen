...
namespace Firebase::Storage::Internal {
  ...
  class TransferStateUpdater_1 : public ::Il2CppObject {
    ...
    [[deprecated]] ::System::IProgress_1<T>*& dyn_handler() {
    ...
    [[deprecated]] ::Firebase::Storage::Internal::TransferState*& dyn_transferState() {
    ...
    [[deprecated]] T& dyn_$ProgressState$k__BackingField() {
    ...
    [[deprecated]] ::Firebase::Storage::MonitorControllerInternal*& dyn_$MonitorController$k__BackingField() {
