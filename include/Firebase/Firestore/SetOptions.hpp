...
namespace Firebase::Firestore {
  ...
  class SetOptions : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(SetOptions::Type), 16 + sizeof(int)> __Firebase_Firestore_SetOptions_TypeSizeCheck;
    static_assert(sizeof(SetOptions::Type) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::Firebase::Firestore::SetOptions::Type) == 0x14);
