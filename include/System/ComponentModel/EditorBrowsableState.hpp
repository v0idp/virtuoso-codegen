...
namespace System::ComponentModel {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EditorBrowsableState), 16 + sizeof(int)> __System_ComponentModel_EditorBrowsableStateSizeCheck;
  static_assert(sizeof(EditorBrowsableState) == 0x14);
}
