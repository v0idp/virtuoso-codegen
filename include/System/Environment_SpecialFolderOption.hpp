...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Environment::SpecialFolderOption), 16 + sizeof(int)> __System_Environment_SpecialFolderOptionSizeCheck;
  static_assert(sizeof(Environment::SpecialFolderOption) == 0x14);
}
