...
namespace System::Globalization {
  ...
  class DateTimeFormatInfoScanner : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(DateTimeFormatInfoScanner::FoundDatePattern), 16 + sizeof(int)> __System_Globalization_DateTimeFormatInfoScanner_FoundDatePatternSizeCheck;
    static_assert(sizeof(DateTimeFormatInfoScanner::FoundDatePattern) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::System::Globalization::DateTimeFormatInfoScanner::FoundDatePattern) == 0x14);
    public:
  ...
  static_assert(sizeof(DateTimeFormatInfoScanner) == 0x2C);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
