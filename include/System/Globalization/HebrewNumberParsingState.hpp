...
namespace System::Globalization {
  ...
  #pragma pack(pop)
  static check_size<sizeof(HebrewNumberParsingState), 16 + sizeof(int)> __System_Globalization_HebrewNumberParsingStateSizeCheck;
  static_assert(sizeof(HebrewNumberParsingState) == 0x14);
}
