...
namespace System::Globalization {
  ...
  // [ComVisibleAttribute] Offset: 57A9DC
  ...
  #pragma pack(pop)
  static check_size<sizeof(CompareOptions), 16 + sizeof(int)> __System_Globalization_CompareOptionsSizeCheck;
  static_assert(sizeof(CompareOptions) == 0x14);
}
