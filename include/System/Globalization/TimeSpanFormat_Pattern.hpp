...
namespace System::Globalization {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TimeSpanFormat::Pattern), 16 + sizeof(int)> __System_Globalization_TimeSpanFormat_PatternSizeCheck;
  static_assert(sizeof(TimeSpanFormat::Pattern) == 0x14);
}
