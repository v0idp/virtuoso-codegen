...
namespace System::Globalization {
  ...
  #pragma pack(pop)
  static check_size<sizeof(DateTimeFormatFlags), 16 + sizeof(int)> __System_Globalization_DateTimeFormatFlagsSizeCheck;
  static_assert(sizeof(DateTimeFormatFlags) == 0x14);
}
