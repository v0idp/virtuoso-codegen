...
namespace System::Globalization {
  ...
  #pragma pack(pop)
  static check_size<sizeof(HebrewNumber::HebrewToken), 16 + sizeof(int)> __System_Globalization_HebrewNumber_HebrewTokenSizeCheck;
  static_assert(sizeof(HebrewNumber::HebrewToken) == 0x14);
}
