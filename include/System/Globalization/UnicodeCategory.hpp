...
namespace System::Globalization {
  ...
  // [ComVisibleAttribute] Offset: 57AB64
  ...
  #pragma pack(pop)
  static check_size<sizeof(UnicodeCategory), 16 + sizeof(int)> __System_Globalization_UnicodeCategorySizeCheck;
  static_assert(sizeof(UnicodeCategory) == 0x14);
}
