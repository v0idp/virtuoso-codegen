...
namespace System::Globalization {
  ...
  // [ComVisibleAttribute] Offset: 57AA74
  ...
  #pragma pack(pop)
  static check_size<sizeof(DateTimeStyles), 16 + sizeof(int)> __System_Globalization_DateTimeStylesSizeCheck;
  static_assert(sizeof(DateTimeStyles) == 0x14);
}
