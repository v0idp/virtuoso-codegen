...
namespace System::Globalization {
  ...
  // [ComVisibleAttribute] Offset: 57AAC4
  ...
  #pragma pack(pop)
  static check_size<sizeof(GregorianCalendarTypes), 16 + sizeof(int)> __System_Globalization_GregorianCalendarTypesSizeCheck;
  static_assert(sizeof(GregorianCalendarTypes) == 0x14);
}
