...
namespace System::Globalization {
  ...
  // [ComVisibleAttribute] Offset: 57AB00
  ...
  #pragma pack(pop)
  static check_size<sizeof(NumberStyles), 16 + sizeof(int)> __System_Globalization_NumberStylesSizeCheck;
  static_assert(sizeof(NumberStyles) == 0x14);
}
