...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Version::ParseFailureKind), 16 + sizeof(int)> __System_Version_ParseFailureKindSizeCheck;
  static_assert(sizeof(Version::ParseFailureKind) == 0x14);
}
