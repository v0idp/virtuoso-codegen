...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: 57905C
  ...
  #pragma pack(pop)
  static check_size<sizeof(Environment::SpecialFolder), 16 + sizeof(int)> __System_Environment_SpecialFolderSizeCheck;
  static_assert(sizeof(Environment::SpecialFolder) == 0x14);
}
