...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Exception::ExceptionMessageKind), 16 + sizeof(int)> __System_Exception_ExceptionMessageKindSizeCheck;
  static_assert(sizeof(Exception::ExceptionMessageKind) == 0x14);
}
