...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ConsoleModifiers), 16 + sizeof(int)> __System_ConsoleModifiersSizeCheck;
  static_assert(sizeof(ConsoleModifiers) == 0x14);
}
