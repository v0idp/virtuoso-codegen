...
namespace System::Diagnostics {
  ...
  #pragma pack(pop)
  static check_size<sizeof(StackTrace::TraceFormat), 16 + sizeof(int)> __System_Diagnostics_StackTrace_TraceFormatSizeCheck;
  static_assert(sizeof(StackTrace::TraceFormat) == 0x14);
}
