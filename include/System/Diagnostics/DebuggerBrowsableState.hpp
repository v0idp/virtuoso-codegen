...
namespace System::Diagnostics {
  ...
  // [ComVisibleAttribute] Offset: 57E998
  ...
  #pragma pack(pop)
  static check_size<sizeof(DebuggerBrowsableState), 16 + sizeof(int)> __System_Diagnostics_DebuggerBrowsableStateSizeCheck;
  static_assert(sizeof(DebuggerBrowsableState) == 0x14);
}
