...
namespace System::Diagnostics {
  ...
  // [AttributeUsageAttribute] Offset: 57E914
  // [ComVisibleAttribute] Offset: 57E914
  class DebuggableAttribute : public ::System::Attribute {
    ...
    // [ComVisibleAttribute] Offset: 57E95C
    ...
    #pragma pack(pop)
    static check_size<sizeof(DebuggableAttribute::DebuggingModes), 16 + sizeof(int)> __System_Diagnostics_DebuggableAttribute_DebuggingModesSizeCheck;
    static_assert(sizeof(DebuggableAttribute::DebuggingModes) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::System::Diagnostics::DebuggableAttribute::DebuggingModes) == 0x14);
    public:
  ...
  static_assert(sizeof(DebuggableAttribute) == 0x24);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
