...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(RuntimeType::MemberListType), 16 + sizeof(int)> __System_RuntimeType_MemberListTypeSizeCheck;
  static_assert(sizeof(RuntimeType::MemberListType) == 0x14);
}
