...
namespace System {
  ...
  class UriParser : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(UriParser::UriQuirksVersion), 16 + sizeof(int)> __System_UriParser_UriQuirksVersionSizeCheck;
    static_assert(sizeof(UriParser::UriQuirksVersion) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::System::UriSyntaxFlags) == 0x14);
