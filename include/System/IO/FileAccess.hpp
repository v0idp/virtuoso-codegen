...
namespace System::IO {
  ...
  // [ComVisibleAttribute] Offset: 57A874
  ...
  #pragma pack(pop)
  static check_size<sizeof(FileAccess), 16 + sizeof(int)> __System_IO_FileAccessSizeCheck;
  static_assert(sizeof(FileAccess) == 0x14);
}
