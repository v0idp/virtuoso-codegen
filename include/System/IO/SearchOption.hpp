...
namespace System::IO {
  ...
  // [ComVisibleAttribute] Offset: 57A9A0
  ...
  #pragma pack(pop)
  static check_size<sizeof(SearchOption), 16 + sizeof(int)> __System_IO_SearchOptionSizeCheck;
  static_assert(sizeof(SearchOption) == 0x14);
}
