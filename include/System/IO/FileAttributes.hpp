...
namespace System::IO {
  ...
  // [ComVisibleAttribute] Offset: 57A8B0
  ...
  #pragma pack(pop)
  static check_size<sizeof(FileAttributes), 16 + sizeof(int)> __System_IO_FileAttributesSizeCheck;
  static_assert(sizeof(FileAttributes) == 0x14);
}
