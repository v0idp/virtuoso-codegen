...
namespace System::IO {
  ...
  // [ComVisibleAttribute] Offset: 57A9B4
  ...
  #pragma pack(pop)
  static check_size<sizeof(SeekOrigin), 16 + sizeof(int)> __System_IO_SeekOriginSizeCheck;
  static_assert(sizeof(SeekOrigin) == 0x14);
}
