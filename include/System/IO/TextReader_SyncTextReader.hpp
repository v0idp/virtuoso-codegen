...
// Writing MetadataGetter for method: System::IO::TextReader::SyncTextReader::ReadToEndAsync
// Il2CppName: ReadToEndAsync
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task_1<::StringW>* (System::IO::TextReader::SyncTextReader::*)()>(&System::IO::TextReader::SyncTextReader::ReadToEndAsync)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::IO::TextReader::SyncTextReader*), "ReadToEndAsync", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
