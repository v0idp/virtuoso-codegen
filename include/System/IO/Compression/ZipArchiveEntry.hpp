...
namespace System::IO::Compression {
  ...
  class ZipArchiveEntry : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(ZipArchiveEntry::BitFlagValues), 16 + sizeof(uint16_t)> __System_IO_Compression_ZipArchiveEntry_BitFlagValuesSizeCheck;
    static_assert(sizeof(ZipArchiveEntry::BitFlagValues) == 0x12);
    // Size: 0x12
    #pragma pack(push, 1)
    ...
    #pragma pack(pop)
    static check_size<sizeof(ZipArchiveEntry::CompressionMethodValues), 16 + sizeof(uint16_t)> __System_IO_Compression_ZipArchiveEntry_CompressionMethodValuesSizeCheck;
    static_assert(sizeof(ZipArchiveEntry::CompressionMethodValues) == 0x12);
    ...
    // Field size check
    static_assert(sizeof(::System::IO::Compression::ZipVersionMadeByPlatform) == 0x11);
    ...
    // Field size check
    static_assert(sizeof(::System::IO::Compression::ZipVersionNeededValues) == 0x12);
    ...
    // Field size check
    static_assert(sizeof(::System::IO::Compression::ZipArchiveEntry::BitFlagValues) == 0x12);
    ...
    // Field size check
    static_assert(sizeof(::System::IO::Compression::ZipArchiveEntry::CompressionMethodValues) == 0x12);
