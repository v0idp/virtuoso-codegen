...
namespace System::IO::Compression {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ZipVersionNeededValues), 16 + sizeof(uint16_t)> __System_IO_Compression_ZipVersionNeededValuesSizeCheck;
  static_assert(sizeof(ZipVersionNeededValues) == 0x12);
}
