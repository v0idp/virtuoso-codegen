...
namespace System::IO::Compression {
  ...
  class DeflaterManaged : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(DeflaterManaged::DeflaterState), 16 + sizeof(int)> __System_IO_Compression_DeflaterManaged_DeflaterStateSizeCheck;
    static_assert(sizeof(DeflaterManaged::DeflaterState) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::System::IO::Compression::DeflaterManaged::DeflaterState) == 0x14);
