...
namespace System::IO {
  ...
  // [ComVisibleAttribute] Offset: 57A900
  ...
  #pragma pack(pop)
  static check_size<sizeof(FileOptions), 16 + sizeof(int)> __System_IO_FileOptionsSizeCheck;
  static_assert(sizeof(FileOptions) == 0x14);
}
