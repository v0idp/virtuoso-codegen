...
namespace System::IO {
  ...
  // [ComVisibleAttribute] Offset: 683590
...
// Writing MetadataGetter for method: System::IO::StringReader::ReadToEndAsync
// Il2CppName: ReadToEndAsync
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task_1<::StringW>* (System::IO::StringReader::*)()>(&System::IO::StringReader::ReadToEndAsync)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::IO::StringReader*), "ReadToEndAsync", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
