...
namespace System::Net::Security {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AuthenticationLevel), 16 + sizeof(int)> __System_Net_Security_AuthenticationLevelSizeCheck;
  static_assert(sizeof(AuthenticationLevel) == 0x14);
}
