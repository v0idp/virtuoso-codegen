...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task* (*)(::System::Net::Sockets::Socket*, ::System::Net::EndPoint*)>(&System::Net::Sockets::SocketTaskExtensions::ConnectAsync)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(System::Net::Sockets::SocketTaskExtensions*), "ConnectAsync", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{socket, remoteEP});
  }
};
