...
namespace System::Net::NetworkInformation {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NetworkInterfaceComponent), 16 + sizeof(int)> __System_Net_NetworkInformation_NetworkInterfaceComponentSizeCheck;
  static_assert(sizeof(NetworkInterfaceComponent) == 0x14);
}
