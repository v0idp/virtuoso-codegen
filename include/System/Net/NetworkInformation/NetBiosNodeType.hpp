...
namespace System::Net::NetworkInformation {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NetBiosNodeType), 16 + sizeof(int)> __System_Net_NetworkInformation_NetBiosNodeTypeSizeCheck;
  static_assert(sizeof(NetBiosNodeType) == 0x14);
}
