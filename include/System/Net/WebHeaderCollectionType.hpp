...
namespace System::Net {
  ...
  #pragma pack(pop)
  static check_size<sizeof(WebHeaderCollectionType), 16 + sizeof(uint16_t)> __System_Net_WebHeaderCollectionTypeSizeCheck;
  static_assert(sizeof(WebHeaderCollectionType) == 0x12);
}
