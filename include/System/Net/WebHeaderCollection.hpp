...
namespace System::Net {
  ...
  // [DefaultMemberAttribute] Offset: 5927F8
  // [ComVisibleAttribute] Offset: 5927F8
  class WebHeaderCollection : public ::System::Collections::Specialized::NameValueCollection {
    ...
    #pragma pack(pop)
    static check_size<sizeof(WebHeaderCollection::RfcChar), 16 + sizeof(uint8_t)> __System_Net_WebHeaderCollection_RfcCharSizeCheck;
    static_assert(sizeof(WebHeaderCollection::RfcChar) == 0x11);
    ...
    // Field size check
    static_assert(sizeof(::System::Net::WebHeaderCollectionType) == 0x12);
    public:
  ...
  static_assert(sizeof(WebHeaderCollection) == 0x92);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
