...
namespace System::Net {
  ...
  class TimerThread::TimerNode : public ::System::Net::TimerThread::Timer {
    ...
    #pragma pack(pop)
    static check_size<sizeof(TimerThread::TimerNode::TimerState), 16 + sizeof(int)> __System_Net_TimerThread_TimerNode_TimerStateSizeCheck;
    static_assert(sizeof(TimerThread::TimerNode::TimerState) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::System::Net::TimerThread::TimerNode::TimerState) == 0x14);
