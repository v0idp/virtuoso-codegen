...
namespace System::Net {
  ...
  #pragma pack(pop)
  static check_size<sizeof(WebCompletionSource::State), 16 + sizeof(int)> __System_Net_WebCompletionSource_StateSizeCheck;
  static_assert(sizeof(WebCompletionSource::State) == 0x14);
}
