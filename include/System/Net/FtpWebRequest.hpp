...
namespace System::Net {
  ...
  class FtpWebRequest : public ::System::Net::WebRequest {
    ...
    #pragma pack(pop)
    static check_size<sizeof(FtpWebRequest::RequestState), 16 + sizeof(int)> __System_Net_FtpWebRequest_RequestStateSizeCheck;
    static_assert(sizeof(FtpWebRequest::RequestState) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::System::Net::FtpWebRequest::RequestState) == 0x14);
