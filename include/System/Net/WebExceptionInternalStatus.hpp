...
namespace System::Net {
  ...
  #pragma pack(pop)
  static check_size<sizeof(WebExceptionInternalStatus), 16 + sizeof(int)> __System_Net_WebExceptionInternalStatusSizeCheck;
  static_assert(sizeof(WebExceptionInternalStatus) == 0x14);
}
