...
namespace System::Net {
  ...
  class MonoChunkStream : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(MonoChunkStream::State), 16 + sizeof(int)> __System_Net_MonoChunkStream_StateSizeCheck;
    static_assert(sizeof(MonoChunkStream::State) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::System::Net::MonoChunkStream::State) == 0x14);
