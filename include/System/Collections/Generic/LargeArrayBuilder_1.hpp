...
namespace System::Collections::Generic {
  ...
  struct LargeArrayBuilder_1/*, public ::System::ValueType*/ {
    ...
    [[deprecated]] int& dyn__maxCapacity() {
    ...
    [[deprecated]] ::ArrayW<T>& dyn__first() {
    ...
    [[deprecated]] ::System::Collections::Generic::ArrayBuilder_1<::ArrayW<T>>& dyn__buffers() {
    ...
    [[deprecated]] ::ArrayW<T>& dyn__current() {
