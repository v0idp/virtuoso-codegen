...
namespace System::Collections::Generic {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InsertionBehavior), 16 + sizeof(uint8_t)> __System_Collections_Generic_InsertionBehaviorSizeCheck;
  static_assert(sizeof(InsertionBehavior) == 0x11);
}
