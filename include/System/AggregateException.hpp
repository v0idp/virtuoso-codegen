...
namespace System {
  ...
  // [DebuggerDisplayAttribute] Offset: 680C00
  class AggregateException : public ::System::Exception {
    ...
    // Offset: 0x113B4E4
    // Implemented from: System.Exception
    // Base method: System.Exception Exception::GetBaseException()
...
// Writing MetadataGetter for method: System::AggregateException::GetBaseException
// Il2CppName: GetBaseException
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Exception* (System::AggregateException::*)()>(&System::AggregateException::GetBaseException)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::AggregateException*), "GetBaseException", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
