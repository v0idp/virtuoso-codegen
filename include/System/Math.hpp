...
namespace System {
  ...
  class Math : public ::Il2CppObject {
    ...
    // static public System.Double Tanh(System.Double value)
    // Offset: 0xECDAB8
...
// Writing MetadataGetter for method: System::Math::Tanh
// Il2CppName: Tanh
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<double (*)(double)>(&System::Math::Tanh)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Double")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Math*), "Tanh", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
