...
namespace System {
  ...
  // [TypeConverterAttribute] Offset: 591BF0
  class Uri : public ::Il2CppObject/*, public ::System::Runtime::Serialization::ISerializable*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(Uri::Flags), 16 + sizeof(uint64_t)> __System_Uri_FlagsSizeCheck;
    static_assert(sizeof(Uri::Flags) == 0x18);
    ...
    // Field size check
    static_assert(sizeof(::System::Uri::Flags) == 0x18);
