...
namespace System::Resources {
  ...
  // [ComVisibleAttribute] Offset: 579548
  ...
  #pragma pack(pop)
  static check_size<sizeof(UltimateResourceFallbackLocation), 16 + sizeof(int)> __System_Resources_UltimateResourceFallbackLocationSizeCheck;
  static_assert(sizeof(UltimateResourceFallbackLocation) == 0x14);
}
