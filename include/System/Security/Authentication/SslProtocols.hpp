...
namespace System::Security::Authentication {
  ...
  struct SslProtocols/*, public ::System::Enum*/ {
    ...
    // [MonoTODOAttribute] Offset: 0x592E9C
    ...
    // [MonoTODOAttribute] Offset: 0x592ED4
  ...
  #pragma pack(pop)
  static check_size<sizeof(SslProtocols), 16 + sizeof(int)> __System_Security_Authentication_SslProtocolsSizeCheck;
  static_assert(sizeof(SslProtocols) == 0x14);
}
