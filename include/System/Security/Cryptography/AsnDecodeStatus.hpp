...
namespace System::Security::Cryptography {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AsnDecodeStatus), 16 + sizeof(int)> __System_Security_Cryptography_AsnDecodeStatusSizeCheck;
  static_assert(sizeof(AsnDecodeStatus) == 0x14);
}
