...
namespace System::Security::Cryptography {
  ...
  // [ComVisibleAttribute] Offset: 57B550
  ...
  #pragma pack(pop)
  static check_size<sizeof(CipherMode), 16 + sizeof(int)> __System_Security_Cryptography_CipherModeSizeCheck;
  static_assert(sizeof(CipherMode) == 0x14);
}
