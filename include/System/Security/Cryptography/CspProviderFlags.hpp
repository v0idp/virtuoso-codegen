...
namespace System::Security::Cryptography {
  ...
  // [ComVisibleAttribute] Offset: 57B5B4
  ...
  #pragma pack(pop)
  static check_size<sizeof(CspProviderFlags), 16 + sizeof(int)> __System_Security_Cryptography_CspProviderFlagsSizeCheck;
  static_assert(sizeof(CspProviderFlags) == 0x14);
}
