...
namespace System::Security::Cryptography {
  ...
  // [ComVisibleAttribute] Offset: 57B564
  ...
  #pragma pack(pop)
  static check_size<sizeof(PaddingMode), 16 + sizeof(int)> __System_Security_Cryptography_PaddingModeSizeCheck;
  static_assert(sizeof(PaddingMode) == 0x14);
}
