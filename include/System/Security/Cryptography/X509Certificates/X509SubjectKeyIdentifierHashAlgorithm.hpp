...
namespace System::Security::Cryptography::X509Certificates {
  ...
  #pragma pack(pop)
  static check_size<sizeof(X509SubjectKeyIdentifierHashAlgorithm), 16 + sizeof(int)> __System_Security_Cryptography_X509Certificates_X509SubjectKeyIdentifierHashAlgorithmSizeCheck;
  static_assert(sizeof(X509SubjectKeyIdentifierHashAlgorithm) == 0x14);
}
