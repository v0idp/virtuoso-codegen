...
namespace System::Security::Cryptography::X509Certificates {
  ...
  #pragma pack(pop)
  static check_size<sizeof(X509ChainStatusFlags), 16 + sizeof(int)> __System_Security_Cryptography_X509Certificates_X509ChainStatusFlagsSizeCheck;
  static_assert(sizeof(X509ChainStatusFlags) == 0x14);
}
