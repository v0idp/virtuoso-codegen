...
namespace System::Security::Cryptography::X509Certificates {
  ...
  #pragma pack(pop)
  static check_size<sizeof(StoreLocation), 16 + sizeof(int)> __System_Security_Cryptography_X509Certificates_StoreLocationSizeCheck;
  static_assert(sizeof(StoreLocation) == 0x14);
}
