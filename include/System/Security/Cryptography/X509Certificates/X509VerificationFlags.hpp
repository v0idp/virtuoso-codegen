...
namespace System::Security::Cryptography::X509Certificates {
  ...
  #pragma pack(pop)
  static check_size<sizeof(X509VerificationFlags), 16 + sizeof(int)> __System_Security_Cryptography_X509Certificates_X509VerificationFlagsSizeCheck;
  static_assert(sizeof(X509VerificationFlags) == 0x14);
}
