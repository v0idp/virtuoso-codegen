...
namespace System::Security::Cryptography::X509Certificates {
  ...
  #pragma pack(pop)
  static check_size<sizeof(X509KeyStorageFlags), 16 + sizeof(int)> __System_Security_Cryptography_X509Certificates_X509KeyStorageFlagsSizeCheck;
  static_assert(sizeof(X509KeyStorageFlags) == 0x14);
}
