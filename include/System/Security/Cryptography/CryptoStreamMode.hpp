...
namespace System::Security::Cryptography {
  ...
  // [ComVisibleAttribute] Offset: 57B604
  ...
  #pragma pack(pop)
  static check_size<sizeof(CryptoStreamMode), 16 + sizeof(int)> __System_Security_Cryptography_CryptoStreamModeSizeCheck;
  static_assert(sizeof(CryptoStreamMode) == 0x14);
}
