...
namespace System::Security::Principal {
  ...
  // [ComVisibleAttribute] Offset: 57B468
  ...
  #pragma pack(pop)
  static check_size<sizeof(TokenImpersonationLevel), 16 + sizeof(int)> __System_Security_Principal_TokenImpersonationLevelSizeCheck;
  static_assert(sizeof(TokenImpersonationLevel) == 0x14);
}
