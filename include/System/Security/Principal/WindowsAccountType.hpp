...
namespace System::Security::Principal {
  ...
  // [ComVisibleAttribute] Offset: 57B47C
  ...
  #pragma pack(pop)
  static check_size<sizeof(WindowsAccountType), 16 + sizeof(int)> __System_Security_Principal_WindowsAccountTypeSizeCheck;
  static_assert(sizeof(WindowsAccountType) == 0x14);
}
