...
namespace System::Security::Util {
  ...
  class Tokenizer : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(Tokenizer::TokenSource), 16 + sizeof(int)> __System_Security_Util_Tokenizer_TokenSourceSizeCheck;
    static_assert(sizeof(Tokenizer::TokenSource) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::System::Security::Util::Tokenizer::TokenSource) == 0x14);
