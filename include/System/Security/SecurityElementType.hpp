...
namespace System::Security {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SecurityElementType), 16 + sizeof(int)> __System_Security_SecurityElementTypeSizeCheck;
  static_assert(sizeof(SecurityElementType) == 0x14);
}
