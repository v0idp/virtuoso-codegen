...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: 579258
  ...
  #pragma pack(pop)
  static check_size<sizeof(StringComparison), 16 + sizeof(int)> __System_StringComparisonSizeCheck;
  static_assert(sizeof(StringComparison) == 0x14);
}
