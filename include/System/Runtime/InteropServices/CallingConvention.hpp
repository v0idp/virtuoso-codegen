...
namespace System::Runtime::InteropServices {
  ...
  // [ComVisibleAttribute] Offset: 57CFF8
  ...
  #pragma pack(pop)
  static check_size<sizeof(CallingConvention), 16 + sizeof(int)> __System_Runtime_InteropServices_CallingConventionSizeCheck;
  static_assert(sizeof(CallingConvention) == 0x14);
}
