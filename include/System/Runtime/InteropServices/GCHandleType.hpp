...
namespace System::Runtime::InteropServices {
  ...
  // [ComVisibleAttribute] Offset: 57D0E8
  ...
  #pragma pack(pop)
  static check_size<sizeof(GCHandleType), 16 + sizeof(int)> __System_Runtime_InteropServices_GCHandleTypeSizeCheck;
  static_assert(sizeof(GCHandleType) == 0x14);
}
