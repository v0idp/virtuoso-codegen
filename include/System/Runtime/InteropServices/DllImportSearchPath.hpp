...
namespace System::Runtime::InteropServices {
  ...
  #pragma pack(pop)
  static check_size<sizeof(DllImportSearchPath), 16 + sizeof(int)> __System_Runtime_InteropServices_DllImportSearchPathSizeCheck;
  static_assert(sizeof(DllImportSearchPath) == 0x14);
}
