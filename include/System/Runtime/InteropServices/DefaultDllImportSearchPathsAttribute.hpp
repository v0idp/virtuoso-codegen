...
namespace System::Runtime::InteropServices {
  ...
  // [AttributeUsageAttribute] Offset: 57CED4
  // [ComVisibleAttribute] Offset: 57CED4
  class DefaultDllImportSearchPathsAttribute : public ::System::Attribute {
    ...
    // Field size check
    static_assert(sizeof(::System::Runtime::InteropServices::DllImportSearchPath) == 0x14);
    public:
  ...
  static_assert(sizeof(DefaultDllImportSearchPathsAttribute) == 0x24);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
