...
namespace System::Runtime::InteropServices {
  ...
  // [ComVisibleAttribute] Offset: 57CB88
  ...
  #pragma pack(pop)
  static check_size<sizeof(ComInterfaceType), 16 + sizeof(int)> __System_Runtime_InteropServices_ComInterfaceTypeSizeCheck;
  static_assert(sizeof(ComInterfaceType) == 0x14);
}
