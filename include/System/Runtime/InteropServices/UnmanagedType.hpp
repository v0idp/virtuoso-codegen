...
namespace System::Runtime::InteropServices {
  ...
  // [ComVisibleAttribute] Offset: 57CCEC
  ...
  #pragma pack(pop)
  static check_size<sizeof(UnmanagedType), 16 + sizeof(int)> __System_Runtime_InteropServices_UnmanagedTypeSizeCheck;
  static_assert(sizeof(UnmanagedType) == 0x14);
}
