...
namespace System::Runtime::InteropServices {
  ...
  // [ComVisibleAttribute] Offset: 57CC40
  // [AttributeUsageAttribute] Offset: 57CC40
  class ClassInterfaceAttribute : public ::System::Attribute {
    ...
    // Field size check
    static_assert(sizeof(::System::Runtime::InteropServices::ClassInterfaceType) == 0x14);
    public:
  ...
  static_assert(sizeof(ClassInterfaceAttribute) == 0x24);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
