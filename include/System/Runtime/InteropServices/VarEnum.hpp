...
namespace System::Runtime::InteropServices {
  ...
  // [ComVisibleAttribute] Offset: 57CCD8
  ...
  #pragma pack(pop)
  static check_size<sizeof(VarEnum), 16 + sizeof(int)> __System_Runtime_InteropServices_VarEnumSizeCheck;
  static_assert(sizeof(VarEnum) == 0x14);
}
