...
namespace System::Runtime::InteropServices {
  ...
  // [ComVisibleAttribute] Offset: 57D00C
  ...
  #pragma pack(pop)
  static check_size<sizeof(CharSet), 16 + sizeof(int)> __System_Runtime_InteropServices_CharSetSizeCheck;
  static_assert(sizeof(CharSet) == 0x14);
}
