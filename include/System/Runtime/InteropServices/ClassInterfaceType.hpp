...
namespace System::Runtime::InteropServices {
  ...
  // [ComVisibleAttribute] Offset: 57CC2C
  ...
  #pragma pack(pop)
  static check_size<sizeof(ClassInterfaceType), 16 + sizeof(int)> __System_Runtime_InteropServices_ClassInterfaceTypeSizeCheck;
  static_assert(sizeof(ClassInterfaceType) == 0x14);
}
