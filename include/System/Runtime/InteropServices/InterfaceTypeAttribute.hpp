...
namespace System::Runtime::InteropServices {
  ...
  // [AttributeUsageAttribute] Offset: 57CB9C
  // [ComVisibleAttribute] Offset: 57CB9C
  class InterfaceTypeAttribute : public ::System::Attribute {
    ...
    // Field size check
    static_assert(sizeof(::System::Runtime::InteropServices::ComInterfaceType) == 0x14);
    public:
  ...
  static_assert(sizeof(InterfaceTypeAttribute) == 0x24);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
