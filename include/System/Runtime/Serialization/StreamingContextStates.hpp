...
namespace System::Runtime::Serialization {
  ...
  // [ComVisibleAttribute] Offset: 57BD48
  ...
  #pragma pack(pop)
  static check_size<sizeof(StreamingContextStates), 16 + sizeof(int)> __System_Runtime_Serialization_StreamingContextStatesSizeCheck;
  static_assert(sizeof(StreamingContextStates) == 0x14);
}
