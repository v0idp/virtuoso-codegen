...
namespace System::Runtime::Serialization::Formatters {
  ...
  // [ComVisibleAttribute] Offset: 57BD84
  ...
  #pragma pack(pop)
  static check_size<sizeof(FormatterTypeStyle), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_FormatterTypeStyleSizeCheck;
  static_assert(sizeof(FormatterTypeStyle) == 0x14);
}
