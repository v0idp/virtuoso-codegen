...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InternalMemberValueE), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_InternalMemberValueESizeCheck;
  static_assert(sizeof(InternalMemberValueE) == 0x14);
}
