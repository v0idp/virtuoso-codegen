...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InternalObjectPositionE), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_InternalObjectPositionESizeCheck;
  static_assert(sizeof(InternalObjectPositionE) == 0x14);
}
