...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ValueFixupEnum), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_ValueFixupEnumSizeCheck;
  static_assert(sizeof(ValueFixupEnum) == 0x14);
}
