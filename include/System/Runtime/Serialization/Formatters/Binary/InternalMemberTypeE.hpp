...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InternalMemberTypeE), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_InternalMemberTypeESizeCheck;
  static_assert(sizeof(InternalMemberTypeE) == 0x14);
}
