...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InternalArrayTypeE), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_InternalArrayTypeESizeCheck;
  static_assert(sizeof(InternalArrayTypeE) == 0x14);
}
