...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InternalParseTypeE), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_InternalParseTypeESizeCheck;
  static_assert(sizeof(InternalParseTypeE) == 0x14);
}
