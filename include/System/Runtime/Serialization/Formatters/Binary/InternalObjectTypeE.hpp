...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InternalObjectTypeE), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_InternalObjectTypeESizeCheck;
  static_assert(sizeof(InternalObjectTypeE) == 0x14);
}
