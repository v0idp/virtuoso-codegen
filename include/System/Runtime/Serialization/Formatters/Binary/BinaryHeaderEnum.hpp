...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BinaryHeaderEnum), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_BinaryHeaderEnumSizeCheck;
  static_assert(sizeof(BinaryHeaderEnum) == 0x14);
}
