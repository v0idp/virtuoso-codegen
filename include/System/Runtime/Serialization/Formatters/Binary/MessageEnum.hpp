...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MessageEnum), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_MessageEnumSizeCheck;
  static_assert(sizeof(MessageEnum) == 0x14);
}
