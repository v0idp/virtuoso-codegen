...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InternalPrimitiveTypeE), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_InternalPrimitiveTypeESizeCheck;
  static_assert(sizeof(InternalPrimitiveTypeE) == 0x14);
}
