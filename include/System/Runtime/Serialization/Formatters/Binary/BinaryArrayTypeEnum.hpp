...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BinaryArrayTypeEnum), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_Binary_BinaryArrayTypeEnumSizeCheck;
  static_assert(sizeof(BinaryArrayTypeEnum) == 0x14);
}
