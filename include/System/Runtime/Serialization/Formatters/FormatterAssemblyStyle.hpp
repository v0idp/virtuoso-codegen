...
namespace System::Runtime::Serialization::Formatters {
  ...
  // [ComVisibleAttribute] Offset: 57BD98
  ...
  #pragma pack(pop)
  static check_size<sizeof(FormatterAssemblyStyle), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_FormatterAssemblyStyleSizeCheck;
  static_assert(sizeof(FormatterAssemblyStyle) == 0x14);
}
