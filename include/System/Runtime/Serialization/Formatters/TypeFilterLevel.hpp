...
namespace System::Runtime::Serialization::Formatters {
  ...
  // [ComVisibleAttribute] Offset: 57BDAC
  ...
  #pragma pack(pop)
  static check_size<sizeof(TypeFilterLevel), 16 + sizeof(int)> __System_Runtime_Serialization_Formatters_TypeFilterLevelSizeCheck;
  static_assert(sizeof(TypeFilterLevel) == 0x14);
}
