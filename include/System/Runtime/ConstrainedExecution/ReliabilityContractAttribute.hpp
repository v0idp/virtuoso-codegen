...
namespace System::Runtime::ConstrainedExecution {
  ...
  // [AttributeUsageAttribute] Offset: 57C650
  class ReliabilityContractAttribute : public ::System::Attribute {
    ...
    // Field size check
    static_assert(sizeof(::System::Runtime::ConstrainedExecution::Consistency) == 0x14);
    // private System.Runtime.ConstrainedExecution.Cer _cer
    // Size: 0x14
    // Offset: 0x14
    ::System::Runtime::ConstrainedExecution::Cer cer;
    // Field size check
    static_assert(sizeof(::System::Runtime::ConstrainedExecution::Cer) == 0x14);
    public:
  ...
  static_assert(sizeof(ReliabilityContractAttribute) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
