...
namespace System::Runtime::CompilerServices {
  ...
  // [AttributeUsageAttribute] Offset: 57C7E8
  class DefaultDependencyAttribute : public ::System::Attribute {
    ...
    // Field size check
    static_assert(sizeof(::System::Runtime::CompilerServices::LoadHint) == 0x14);
    public:
  ...
  static_assert(sizeof(DefaultDependencyAttribute) == 0x24);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
