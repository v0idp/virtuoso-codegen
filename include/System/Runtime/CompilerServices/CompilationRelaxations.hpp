...
namespace System::Runtime::CompilerServices {
  ...
  // [ComVisibleAttribute] Offset: 57C7FC
  ...
  #pragma pack(pop)
  static check_size<sizeof(CompilationRelaxations), 16 + sizeof(int)> __System_Runtime_CompilerServices_CompilationRelaxationsSizeCheck;
  static_assert(sizeof(CompilationRelaxations) == 0x14);
}
