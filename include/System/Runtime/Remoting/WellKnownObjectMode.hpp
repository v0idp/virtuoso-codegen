...
namespace System::Runtime::Remoting {
  ...
  // [ComVisibleAttribute] Offset: 57BF58
  ...
  #pragma pack(pop)
  static check_size<sizeof(WellKnownObjectMode), 16 + sizeof(int)> __System_Runtime_Remoting_WellKnownObjectModeSizeCheck;
  static_assert(sizeof(WellKnownObjectMode) == 0x14);
}
