...
namespace System::Runtime::Remoting::Lifetime {
  ...
  // [ComVisibleAttribute] Offset: 57C024
  ...
  #pragma pack(pop)
  static check_size<sizeof(LeaseState), 16 + sizeof(int)> __System_Runtime_Remoting_Lifetime_LeaseStateSizeCheck;
  static_assert(sizeof(LeaseState) == 0x14);
}
