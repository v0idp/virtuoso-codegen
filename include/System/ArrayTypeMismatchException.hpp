...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: 680F58
  class ArrayTypeMismatchException : public ::System::SystemException {
    ...
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static ArrayTypeMismatchException* New_ctor(::StringW message) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::ArrayTypeMismatchException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ArrayTypeMismatchException*, creationType>(message)));
    }
