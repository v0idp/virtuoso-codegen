...
namespace System::Threading {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ExecutionContext::CaptureOptions), 16 + sizeof(int)> __System_Threading_ExecutionContext_CaptureOptionsSizeCheck;
  static_assert(sizeof(ExecutionContext::CaptureOptions) == 0x14);
}
