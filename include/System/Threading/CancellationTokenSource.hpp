...
namespace System::Threading {
  ...
  // [ComVisibleAttribute] Offset: 6839E8
  class CancellationTokenSource : public ::Il2CppObject/*, public ::System::IDisposable*/ {
    ...
    // static public System.Threading.CancellationTokenSource CreateLinkedTokenSource(params System.Threading.CancellationToken[] tokens)
    // Offset: 0xFF91FC
    static ::System::Threading::CancellationTokenSource* CreateLinkedTokenSource(::ArrayW<::System::Threading::CancellationToken> tokens);
...
// Il2CppName: CreateLinkedTokenSource
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::CancellationTokenSource* (*)(::ArrayW<::System::Threading::CancellationToken>)>(&System::Threading::CancellationTokenSource::CreateLinkedTokenSource)> {
  static const MethodInfo* get() {
    static auto* tokens = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System.Threading", "CancellationToken"), 1)->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Threading::CancellationTokenSource*), "CreateLinkedTokenSource", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{tokens});
  }
};
