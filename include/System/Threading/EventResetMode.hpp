...
namespace System::Threading {
  ...
  // [ComVisibleAttribute] Offset: 57ADC0
  ...
  #pragma pack(pop)
  static check_size<sizeof(EventResetMode), 16 + sizeof(int)> __System_Threading_EventResetModeSizeCheck;
  static_assert(sizeof(EventResetMode) == 0x14);
}
