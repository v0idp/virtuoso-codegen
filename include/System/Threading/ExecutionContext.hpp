...
namespace System::Threading {
  ...
  class ExecutionContext : public ::Il2CppObject/*, public ::System::IDisposable, public ::System::Runtime::Serialization::ISerializable*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(ExecutionContext::Flags), 16 + sizeof(int)> __System_Threading_ExecutionContext_FlagsSizeCheck;
    static_assert(sizeof(ExecutionContext::Flags) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::System::Threading::ExecutionContext::Flags) == 0x14);
