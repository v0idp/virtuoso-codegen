...
namespace System::Threading {
  ...
  // [ComVisibleAttribute] Offset: 57AFCC
  ...
  #pragma pack(pop)
  static check_size<sizeof(ThreadState), 16 + sizeof(int)> __System_Threading_ThreadStateSizeCheck;
  static_assert(sizeof(ThreadState) == 0x14);
}
