...
namespace System::Threading {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SynchronizationContextProperties), 16 + sizeof(int)> __System_Threading_SynchronizationContextPropertiesSizeCheck;
  static_assert(sizeof(SynchronizationContextProperties) == 0x14);
}
