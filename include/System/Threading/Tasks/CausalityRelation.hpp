...
namespace System::Threading::Tasks {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CausalityRelation), 16 + sizeof(int)> __System_Threading_Tasks_CausalityRelationSizeCheck;
  static_assert(sizeof(CausalityRelation) == 0x14);
}
