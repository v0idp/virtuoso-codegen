...
namespace System::Threading::Tasks {
  ...
  class TaskCompletionSource_1 : public ::Il2CppObject {
    ...
    // public System.Void SetException(System.AggregateException param_00002602)
    // Offset: 0xFFFFFFFFFFFFFFFF
    void SetException(::System::AggregateException* param_00002602) {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Threading::Tasks::TaskCompletionSource_1::SetException");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "SetException", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(param_00002602)})));
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, param_00002602);
    }
