...
namespace System::Threading::Tasks {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InternalTaskOptions), 16 + sizeof(int)> __System_Threading_Tasks_InternalTaskOptionsSizeCheck;
  static_assert(sizeof(InternalTaskOptions) == 0x14);
}
