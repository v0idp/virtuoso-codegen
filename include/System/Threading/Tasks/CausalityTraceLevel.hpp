...
namespace System::Threading::Tasks {
  ...
  // [FriendAccessAllowedAttribute] Offset: 57B0BC
  ...
  #pragma pack(pop)
  static check_size<sizeof(CausalityTraceLevel), 16 + sizeof(int)> __System_Threading_Tasks_CausalityTraceLevelSizeCheck;
  static_assert(sizeof(CausalityTraceLevel) == 0x14);
}
