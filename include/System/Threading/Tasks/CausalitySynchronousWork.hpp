...
namespace System::Threading::Tasks {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CausalitySynchronousWork), 16 + sizeof(int)> __System_Threading_Tasks_CausalitySynchronousWorkSizeCheck;
  static_assert(sizeof(CausalitySynchronousWork) == 0x14);
}
