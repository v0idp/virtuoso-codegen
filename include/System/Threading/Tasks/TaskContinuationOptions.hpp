...
namespace System::Threading::Tasks {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TaskContinuationOptions), 16 + sizeof(int)> __System_Threading_Tasks_TaskContinuationOptionsSizeCheck;
  static_assert(sizeof(TaskContinuationOptions) == 0x14);
}
