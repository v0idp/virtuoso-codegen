...
namespace System::Threading::Tasks {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TaskCreationOptions), 16 + sizeof(int)> __System_Threading_Tasks_TaskCreationOptionsSizeCheck;
  static_assert(sizeof(TaskCreationOptions) == 0x14);
}
