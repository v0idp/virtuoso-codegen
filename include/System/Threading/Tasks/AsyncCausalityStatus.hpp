...
namespace System::Threading::Tasks {
  ...
  // [FriendAccessAllowedAttribute] Offset: 57B0CC
  ...
  #pragma pack(pop)
  static check_size<sizeof(AsyncCausalityStatus), 16 + sizeof(int)> __System_Threading_Tasks_AsyncCausalityStatusSizeCheck;
  static_assert(sizeof(AsyncCausalityStatus) == 0x14);
}
