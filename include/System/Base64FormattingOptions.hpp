...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Base64FormattingOptions), 16 + sizeof(int)> __System_Base64FormattingOptionsSizeCheck;
  static_assert(sizeof(Base64FormattingOptions) == 0x14);
}
