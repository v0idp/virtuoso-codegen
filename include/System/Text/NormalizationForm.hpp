...
namespace System::Text {
  ...
  // [ComVisibleAttribute] Offset: 57944C
  ...
  #pragma pack(pop)
  static check_size<sizeof(NormalizationForm), 16 + sizeof(int)> __System_Text_NormalizationFormSizeCheck;
  static_assert(sizeof(NormalizationForm) == 0x14);
}
