...
namespace System::Buffers {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ArrayPoolEventSource::BufferAllocatedReason), 16 + sizeof(int)> __System_Buffers_ArrayPoolEventSource_BufferAllocatedReasonSizeCheck;
  static_assert(sizeof(ArrayPoolEventSource::BufferAllocatedReason) == 0x14);
}
