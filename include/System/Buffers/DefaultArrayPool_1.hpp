...
namespace System::Buffers {
  ...
  class DefaultArrayPool_1 : public ::System::Buffers::ArrayPool_1<T> {
    ...
    class Bucket : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      [[deprecated]] int& dyn__bufferLength() {
      ...
      [[deprecated]] ::ArrayW<::ArrayW<T>>& dyn__buffers() {
      ...
      [[deprecated]] ::System::Threading::SpinLock& dyn__lock() {
    ...
    [[deprecated]] ::ArrayW<typename ::System::Buffers::DefaultArrayPool_1<T>::Bucket*>& dyn__buckets() {
