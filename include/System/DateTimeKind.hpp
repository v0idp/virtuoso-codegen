...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: 5783FC
  ...
  #pragma pack(pop)
  static check_size<sizeof(DateTimeKind), 16 + sizeof(int)> __System_DateTimeKindSizeCheck;
  static_assert(sizeof(DateTimeKind) == 0x14);
}
