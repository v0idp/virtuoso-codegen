...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: 578BE0
  ...
  #pragma pack(pop)
  static check_size<sizeof(StringSplitOptions), 16 + sizeof(int)> __System_StringSplitOptionsSizeCheck;
  static_assert(sizeof(StringSplitOptions) == 0x14);
}
