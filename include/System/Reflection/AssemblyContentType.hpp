...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579934
  ...
  #pragma pack(pop)
  static check_size<sizeof(AssemblyContentType), 16 + sizeof(int)> __System_Reflection_AssemblyContentTypeSizeCheck;
  static_assert(sizeof(AssemblyContentType) == 0x14);
}
