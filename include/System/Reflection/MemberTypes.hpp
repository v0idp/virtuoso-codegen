...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579BB0
  ...
  #pragma pack(pop)
  static check_size<sizeof(MemberTypes), 16 + sizeof(int)> __System_Reflection_MemberTypesSizeCheck;
  static_assert(sizeof(MemberTypes) == 0x14);
}
