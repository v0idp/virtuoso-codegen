...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579A54
  ...
  #pragma pack(pop)
  static check_size<sizeof(EventAttributes), 16 + sizeof(int)> __System_Reflection_EventAttributesSizeCheck;
  static_assert(sizeof(EventAttributes) == 0x14);
}
