...
namespace System::Reflection {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GenericParameterAttributes), 16 + sizeof(int)> __System_Reflection_GenericParameterAttributesSizeCheck;
  static_assert(sizeof(GenericParameterAttributes) == 0x14);
}
