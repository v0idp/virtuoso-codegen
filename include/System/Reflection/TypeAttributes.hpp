...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579EF4
  ...
  #pragma pack(pop)
  static check_size<sizeof(TypeAttributes), 16 + sizeof(int)> __System_Reflection_TypeAttributesSizeCheck;
  static_assert(sizeof(TypeAttributes) == 0x14);
}
