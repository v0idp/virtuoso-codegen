...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 57999C
  ...
  #pragma pack(pop)
  static check_size<sizeof(BindingFlags), 16 + sizeof(int)> __System_Reflection_BindingFlagsSizeCheck;
  static_assert(sizeof(BindingFlags) == 0x14);
}
