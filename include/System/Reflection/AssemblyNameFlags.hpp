...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 5798F8
  ...
  #pragma pack(pop)
  static check_size<sizeof(AssemblyNameFlags), 16 + sizeof(int)> __System_Reflection_AssemblyNameFlagsSizeCheck;
  static_assert(sizeof(AssemblyNameFlags) == 0x14);
}
