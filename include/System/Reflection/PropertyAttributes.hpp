...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579E68
  ...
  #pragma pack(pop)
  static check_size<sizeof(PropertyAttributes), 16 + sizeof(int)> __System_Reflection_PropertyAttributesSizeCheck;
  static_assert(sizeof(PropertyAttributes) == 0x14);
}
