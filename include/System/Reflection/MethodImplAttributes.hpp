...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579CEC
  ...
  #pragma pack(pop)
  static check_size<sizeof(MethodImplAttributes), 16 + sizeof(int)> __System_Reflection_MethodImplAttributesSizeCheck;
  static_assert(sizeof(MethodImplAttributes) == 0x14);
}
