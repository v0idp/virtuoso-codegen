...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579D9C
  ...
  #pragma pack(pop)
  static check_size<sizeof(ParameterAttributes), 16 + sizeof(int)> __System_Reflection_ParameterAttributesSizeCheck;
  static_assert(sizeof(ParameterAttributes) == 0x14);
}
