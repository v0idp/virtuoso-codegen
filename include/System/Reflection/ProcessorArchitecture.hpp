...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579948
  ...
  #pragma pack(pop)
  static check_size<sizeof(ProcessorArchitecture), 16 + sizeof(int)> __System_Reflection_ProcessorArchitectureSizeCheck;
  static_assert(sizeof(ProcessorArchitecture) == 0x14);
}
