...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579BEC
  ...
  #pragma pack(pop)
  static check_size<sizeof(MethodAttributes), 16 + sizeof(int)> __System_Reflection_MethodAttributesSizeCheck;
  static_assert(sizeof(MethodAttributes) == 0x14);
}
