...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579CB0
  ...
  #pragma pack(pop)
  static check_size<sizeof(ExceptionHandlingClauseOptions), 16 + sizeof(int)> __System_Reflection_ExceptionHandlingClauseOptionsSizeCheck;
  static_assert(sizeof(ExceptionHandlingClauseOptions) == 0x14);
}
