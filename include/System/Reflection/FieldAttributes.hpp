...
namespace System::Reflection {
  ...
  // [ComVisibleAttribute] Offset: 579A90
  ...
  #pragma pack(pop)
  static check_size<sizeof(FieldAttributes), 16 + sizeof(int)> __System_Reflection_FieldAttributesSizeCheck;
  static_assert(sizeof(FieldAttributes) == 0x14);
}
