...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Guid::GuidParseThrowStyle), 16 + sizeof(int)> __System_Guid_GuidParseThrowStyleSizeCheck;
  static_assert(sizeof(Guid::GuidParseThrowStyle) == 0x14);
}
