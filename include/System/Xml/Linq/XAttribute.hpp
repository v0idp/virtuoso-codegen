...
namespace System::Xml::Linq {
  ...
  // [TypeDescriptionProviderAttribute] Offset: 6E5ABC
...
// Writing MetadataGetter for method: System::Xml::Linq::XAttribute::set_Value
// Il2CppName: set_Value
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Linq::XAttribute::*)(::StringW)>(&System::Xml::Linq::XAttribute::set_Value)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Xml::Linq::XAttribute*), "set_Value", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
