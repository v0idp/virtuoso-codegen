...
namespace System::Xml::Linq {
  ...
  class XHashtable_1 : public ::Il2CppObject {
    ...
    class XHashtableState : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      [[deprecated]] ::ArrayW<typename ::System::Xml::Linq::XHashtable_1<TValue>::XHashtableState::Entry>& dyn_entries() {
      ...
      [[deprecated]] typename ::System::Xml::Linq::XHashtable_1<TValue>::ExtractKeyDelegate*& dyn_extractKey() {
    ...
    [[deprecated]] typename ::System::Xml::Linq::XHashtable_1<TValue>::XHashtableState*& dyn_state() {
