...
namespace System::Xml::Linq {
  ...
  class XNode : public ::System::Xml::Linq::XObject {
    ...
    // Offset: 0x185D31C
    void Remove();
    // public System.String ToString(System.Xml.Linq.SaveOptions options)
    // Offset: 0x185C80C
    ::StringW ToString(::System::Xml::Linq::SaveOptions options);
...
// Il2CppName: ToString
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Xml::Linq::XNode::*)(::System::Xml::Linq::SaveOptions)>(&System::Xml::Linq::XNode::ToString)> {
  static const MethodInfo* get() {
    static auto* options = &::il2cpp_utils::GetClassFromName("System.Xml.Linq", "SaveOptions")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Xml::Linq::XNode*), "ToString", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{options});
  }
};
