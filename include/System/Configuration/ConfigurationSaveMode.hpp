...
namespace System::Configuration {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ConfigurationSaveMode), 16 + sizeof(int)> __System_Configuration_ConfigurationSaveModeSizeCheck;
  static_assert(sizeof(ConfigurationSaveMode) == 0x14);
}
