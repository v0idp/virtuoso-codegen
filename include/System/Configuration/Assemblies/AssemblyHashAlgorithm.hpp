...
namespace System::Configuration::Assemblies {
  ...
  // [ComVisibleAttribute] Offset: 579320
  ...
  #pragma pack(pop)
  static check_size<sizeof(AssemblyHashAlgorithm), 16 + sizeof(int)> __System_Configuration_Assemblies_AssemblyHashAlgorithmSizeCheck;
  static_assert(sizeof(AssemblyHashAlgorithm) == 0x14);
}
