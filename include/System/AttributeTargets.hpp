...
namespace System {
  ...
  // [FlagsAttribute] Offset: 57821C
  // [ComVisibleAttribute] Offset: 57821C
  ...
  #pragma pack(pop)
  static check_size<sizeof(AttributeTargets), 16 + sizeof(int)> __System_AttributeTargetsSizeCheck;
  static_assert(sizeof(AttributeTargets) == 0x14);
}
