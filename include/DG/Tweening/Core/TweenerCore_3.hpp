...
namespace DG::Tweening::Core {
  ...
  class TweenerCore_3 : public ::DG::Tweening::Tweener {
    ...
    ::DG::Tweening::Core::DOGetter_1<T1>*& dyn_getter() {
    ...
    ::DG::Tweening::Core::DOSetter_1<T1>*& dyn_setter() {
    ...
    ::DG::Tweening::Plugins::Core::ABSTweenPlugin_3<T1, T2, TPlugOptions>*& dyn_tweenPlugin() {
