...
namespace DG::Tweening::Core {
  ...
  class TweenerCore_3 : public ::DG::Tweening::Tweener {
    ...
    [[deprecated]] TPlugOptions& dyn_plugOptions() {
    ...
    [[deprecated]] ::DG::Tweening::Core::DOGetter_1<T1>*& dyn_getter() {
    ...
    [[deprecated]] ::DG::Tweening::Core::DOSetter_1<T1>*& dyn_setter() {
    ...
    [[deprecated]] ::DG::Tweening::Plugins::Core::ABSTweenPlugin_3<T1, T2, TPlugOptions>*& dyn_tweenPlugin() {
