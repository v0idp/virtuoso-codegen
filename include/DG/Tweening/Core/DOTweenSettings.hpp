...
namespace DG::Tweening::Core {
  ...
  class DOTweenSettings : public ::UnityEngine::ScriptableObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(DOTweenSettings::SettingsLocation), 16 + sizeof(int)> __DG_Tweening_Core_DOTweenSettings_SettingsLocationSizeCheck;
    static_assert(sizeof(DOTweenSettings::SettingsLocation) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::DG::Tweening::Core::Enums::RewindCallbackMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::DG::Tweening::LogBehaviour) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::DG::Tweening::AutoPlay) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::DG::Tweening::Core::DOTweenSettings::SettingsLocation) == 0x14);
