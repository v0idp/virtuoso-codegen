...
namespace DG::Tweening::Core::Enums {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SpecialStartupMode), 16 + sizeof(int)> __DG_Tweening_Core_Enums_SpecialStartupModeSizeCheck;
  static_assert(sizeof(SpecialStartupMode) == 0x14);
}
