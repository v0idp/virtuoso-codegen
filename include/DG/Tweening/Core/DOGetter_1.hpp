...
namespace DG::Tweening::Core {
  ...
  // Autogenerated type: DG.Tweening.Core.DOGetter`1
  ...
  class DOGetter_1 : public ::System::MulticastDelegate {
    ...
    static DOGetter_1<T>* New_ctor(::Il2CppObject* object, ::System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("::DG::Tweening::Core::DOGetter_1::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<DOGetter_1<T>*, creationType>(object, method)));
    }
    // public T Invoke()
    // Offset: 0xFFFFFFFFFFFFFFFF
    T Invoke() {
  ...
  // Could not write size check! Type: DG.Tweening.Core.DOGetter`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
