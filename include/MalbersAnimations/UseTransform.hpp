...
namespace MalbersAnimations {
  ...
  class UseTransform : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(UseTransform::UpdateMode), 16 + sizeof(int)> __MalbersAnimations_UseTransform_UpdateModeSizeCheck;
    static_assert(sizeof(UseTransform::UpdateMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::MalbersAnimations::UseTransform::UpdateMode) == 0x14);
    public:
  ...
  static_assert(sizeof(UseTransform) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
