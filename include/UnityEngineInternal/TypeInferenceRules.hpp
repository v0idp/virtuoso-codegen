...
namespace UnityEngineInternal {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TypeInferenceRules), 16 + sizeof(int)> __UnityEngineInternal_TypeInferenceRulesSizeCheck;
  static_assert(sizeof(TypeInferenceRules) == 0x14);
}
