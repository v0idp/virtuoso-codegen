...
namespace UnityEngineInternal::Input {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NativeInputUpdateType), 16 + sizeof(int)> __UnityEngineInternal_Input_NativeInputUpdateTypeSizeCheck;
  static_assert(sizeof(NativeInputUpdateType) == 0x14);
}
