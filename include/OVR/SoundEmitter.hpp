...
namespace OVR {
  ...
  class SoundEmitter : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(SoundEmitter::FadeState), 16 + sizeof(int)> __OVR_SoundEmitter_FadeStateSizeCheck;
    static_assert(sizeof(SoundEmitter::FadeState) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::OVR::EmitterChannel) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::OVR::SoundEmitter::FadeState) == 0x14);
