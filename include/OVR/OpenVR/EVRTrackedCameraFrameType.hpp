...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRTrackedCameraFrameType), 16 + sizeof(int)> __OVR_OpenVR_EVRTrackedCameraFrameTypeSizeCheck;
  static_assert(sizeof(EVRTrackedCameraFrameType) == 0x14);
}
