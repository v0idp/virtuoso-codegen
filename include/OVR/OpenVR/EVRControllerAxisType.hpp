...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRControllerAxisType), 16 + sizeof(int)> __OVR_OpenVR_EVRControllerAxisTypeSizeCheck;
  static_assert(sizeof(EVRControllerAxisType) == 0x14);
}
