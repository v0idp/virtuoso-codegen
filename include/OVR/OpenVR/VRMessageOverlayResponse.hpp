...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(VRMessageOverlayResponse), 16 + sizeof(int)> __OVR_OpenVR_VRMessageOverlayResponseSizeCheck;
  static_assert(sizeof(VRMessageOverlayResponse) == 0x14);
}
