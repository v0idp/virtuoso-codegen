...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EGamepadTextInputMode), 16 + sizeof(int)> __OVR_OpenVR_EGamepadTextInputModeSizeCheck;
  static_assert(sizeof(EGamepadTextInputMode) == 0x14);
}
