...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRTrackedCameraFrameLayout), 16 + sizeof(int)> __OVR_OpenVR_EVRTrackedCameraFrameLayoutSizeCheck;
  static_assert(sizeof(EVRTrackedCameraFrameLayout) == 0x14);
}
