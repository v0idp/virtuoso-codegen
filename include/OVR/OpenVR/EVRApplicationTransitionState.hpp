...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRApplicationTransitionState), 16 + sizeof(int)> __OVR_OpenVR_EVRApplicationTransitionStateSizeCheck;
  static_assert(sizeof(EVRApplicationTransitionState) == 0x14);
}
