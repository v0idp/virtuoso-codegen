...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(VROverlayTransformType), 16 + sizeof(int)> __OVR_OpenVR_VROverlayTransformTypeSizeCheck;
  static_assert(sizeof(VROverlayTransformType) == 0x14);
}
