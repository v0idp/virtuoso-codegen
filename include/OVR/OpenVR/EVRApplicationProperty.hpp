...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRApplicationProperty), 16 + sizeof(int)> __OVR_OpenVR_EVRApplicationPropertySizeCheck;
  static_assert(sizeof(EVRApplicationProperty) == 0x14);
}
