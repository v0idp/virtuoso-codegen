...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ETrackedPropertyError), 16 + sizeof(int)> __OVR_OpenVR_ETrackedPropertyErrorSizeCheck;
  static_assert(sizeof(ETrackedPropertyError) == 0x14);
}
