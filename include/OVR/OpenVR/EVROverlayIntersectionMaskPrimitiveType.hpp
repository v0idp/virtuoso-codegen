...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVROverlayIntersectionMaskPrimitiveType), 16 + sizeof(int)> __OVR_OpenVR_EVROverlayIntersectionMaskPrimitiveTypeSizeCheck;
  static_assert(sizeof(EVROverlayIntersectionMaskPrimitiveType) == 0x14);
}
