...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ETrackedControllerRole), 16 + sizeof(int)> __OVR_OpenVR_ETrackedControllerRoleSizeCheck;
  static_assert(sizeof(ETrackedControllerRole) == 0x14);
}
