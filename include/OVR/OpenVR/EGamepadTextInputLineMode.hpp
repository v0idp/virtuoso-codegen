...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EGamepadTextInputLineMode), 16 + sizeof(int)> __OVR_OpenVR_EGamepadTextInputLineModeSizeCheck;
  static_assert(sizeof(EGamepadTextInputLineMode) == 0x14);
}
