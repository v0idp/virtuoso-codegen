...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ECollisionBoundsStyle), 16 + sizeof(int)> __OVR_OpenVR_ECollisionBoundsStyleSizeCheck;
  static_assert(sizeof(ECollisionBoundsStyle) == 0x14);
}
