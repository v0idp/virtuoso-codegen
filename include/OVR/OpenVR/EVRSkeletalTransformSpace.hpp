...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRSkeletalTransformSpace), 16 + sizeof(int)> __OVR_OpenVR_EVRSkeletalTransformSpaceSizeCheck;
  static_assert(sizeof(EVRSkeletalTransformSpace) == 0x14);
}
