...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRSpatialAnchorError), 16 + sizeof(int)> __OVR_OpenVR_EVRSpatialAnchorErrorSizeCheck;
  static_assert(sizeof(EVRSpatialAnchorError) == 0x14);
}
