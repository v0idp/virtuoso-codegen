...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRTrackedCameraError), 16 + sizeof(int)> __OVR_OpenVR_EVRTrackedCameraErrorSizeCheck;
  static_assert(sizeof(EVRTrackedCameraError) == 0x14);
}
