...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EChaperoneImportFlags), 16 + sizeof(int)> __OVR_OpenVR_EChaperoneImportFlagsSizeCheck;
  static_assert(sizeof(EChaperoneImportFlags) == 0x14);
}
