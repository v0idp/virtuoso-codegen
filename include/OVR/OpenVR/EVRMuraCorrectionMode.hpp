...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRMuraCorrectionMode), 16 + sizeof(int)> __OVR_OpenVR_EVRMuraCorrectionModeSizeCheck;
  static_assert(sizeof(EVRMuraCorrectionMode) == 0x14);
}
