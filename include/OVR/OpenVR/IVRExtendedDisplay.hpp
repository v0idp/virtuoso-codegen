...
namespace OVR::OpenVR {
  ...
  struct IVRExtendedDisplay/*, public ::System::ValueType*/ {
    ...
    [[deprecated]] ::OVR::OpenVR::IVRExtendedDisplay::_GetWindowBounds*& dyn_GetWindowBounds();
    // Get instance field reference: OVR.OpenVR.IVRExtendedDisplay/OVR.OpenVR._GetEyeOutputViewport GetEyeOutputViewport
    [[deprecated]] ::OVR::OpenVR::IVRExtendedDisplay::_GetEyeOutputViewport*& dyn_GetEyeOutputViewport();
    // Get instance field reference: OVR.OpenVR.IVRExtendedDisplay/OVR.OpenVR._GetDXGIOutputInfo GetDXGIOutputInfo
    [[deprecated]] ::OVR::OpenVR::IVRExtendedDisplay::_GetDXGIOutputInfo*& dyn_GetDXGIOutputInfo();
