...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRCompositorTimingMode), 16 + sizeof(int)> __OVR_OpenVR_EVRCompositorTimingModeSizeCheck;
  static_assert(sizeof(EVRCompositorTimingMode) == 0x14);
}
