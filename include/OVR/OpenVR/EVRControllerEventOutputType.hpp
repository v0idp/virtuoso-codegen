...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRControllerEventOutputType), 16 + sizeof(int)> __OVR_OpenVR_EVRControllerEventOutputTypeSizeCheck;
  static_assert(sizeof(EVRControllerEventOutputType) == 0x14);
}
