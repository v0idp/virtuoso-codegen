...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ChaperoneCalibrationState), 16 + sizeof(int)> __OVR_OpenVR_ChaperoneCalibrationStateSizeCheck;
  static_assert(sizeof(ChaperoneCalibrationState) == 0x14);
}
