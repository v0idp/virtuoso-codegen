...
namespace OVR::OpenVR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EVRScreenshotPropertyFilenames), 16 + sizeof(int)> __OVR_OpenVR_EVRScreenshotPropertyFilenamesSizeCheck;
  static_assert(sizeof(EVRScreenshotPropertyFilenames) == 0x14);
}
