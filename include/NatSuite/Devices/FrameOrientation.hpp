...
namespace NatSuite::Devices {
  ...
  #pragma pack(pop)
  static check_size<sizeof(FrameOrientation), 16 + sizeof(int)> __NatSuite_Devices_FrameOrientationSizeCheck;
  static_assert(sizeof(FrameOrientation) == 0x14);
}
