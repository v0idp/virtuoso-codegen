...
namespace NatSuite::Devices {
  ...
  class MediaDeviceQuery::$$c__DisplayClass2_0_1 : public ::Il2CppObject {
    ...
    [[deprecated]] ::System::Threading::Tasks::TaskCompletionSource_1<bool>*& dyn_permissionTask() {
    ...
    [[deprecated]] ::NatSuite::Devices::MediaDeviceQuery::MediaDeviceQueryPermissionsHelper*& dyn_requester() {
