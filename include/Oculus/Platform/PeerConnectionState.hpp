...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PeerConnectionState), 16 + sizeof(int)> __Oculus_Platform_PeerConnectionStateSizeCheck;
  static_assert(sizeof(PeerConnectionState) == 0x14);
}
