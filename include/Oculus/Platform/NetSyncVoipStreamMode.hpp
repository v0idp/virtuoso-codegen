...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NetSyncVoipStreamMode), 16 + sizeof(int)> __Oculus_Platform_NetSyncVoipStreamModeSizeCheck;
  static_assert(sizeof(NetSyncVoipStreamMode) == 0x14);
}
