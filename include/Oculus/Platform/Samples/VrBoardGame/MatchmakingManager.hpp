...
namespace Oculus::Platform::Samples::VrBoardGame {
  ...
  class MatchmakingManager : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(MatchmakingManager::MatchRoomState), 16 + sizeof(int)> __Oculus_Platform_Samples_VrBoardGame_MatchmakingManager_MatchRoomStateSizeCheck;
    static_assert(sizeof(MatchmakingManager::MatchRoomState) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::Oculus::Platform::Samples::VrBoardGame::MatchmakingManager::MatchRoomState) == 0x14);
    public:
  ...
  static_assert(sizeof(MatchmakingManager) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
