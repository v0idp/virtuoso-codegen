...
namespace Oculus::Platform::Samples::VrVoiceChat {
  ...
  class PlatformManager : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(PlatformManager::State), 16 + sizeof(int)> __Oculus_Platform_Samples_VrVoiceChat_PlatformManager_StateSizeCheck;
    ...
    // Field size check
    static_assert(sizeof(::Oculus::Platform::Samples::VrVoiceChat::PlatformManager::State) == 0x14);
