...
namespace Oculus::Platform::Samples::VrHoops {
  ...
  class DetectBasket : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(DetectBasket::BasketPhase), 16 + sizeof(int)> __Oculus_Platform_Samples_VrHoops_DetectBasket_BasketPhaseSizeCheck;
    static_assert(sizeof(DetectBasket::BasketPhase) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::Oculus::Platform::Samples::VrHoops::DetectBasket::BasketPhase) == 0x14);
