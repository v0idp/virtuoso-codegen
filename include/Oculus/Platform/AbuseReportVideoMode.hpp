...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AbuseReportVideoMode), 16 + sizeof(int)> __Oculus_Platform_AbuseReportVideoModeSizeCheck;
  static_assert(sizeof(AbuseReportVideoMode) == 0x14);
}
