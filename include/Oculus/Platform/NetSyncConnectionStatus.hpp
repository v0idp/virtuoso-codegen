...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NetSyncConnectionStatus), 16 + sizeof(int)> __Oculus_Platform_NetSyncConnectionStatusSizeCheck;
  static_assert(sizeof(NetSyncConnectionStatus) == 0x14);
}
