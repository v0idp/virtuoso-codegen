...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LivestreamingMicrophoneStatus), 16 + sizeof(int)> __Oculus_Platform_LivestreamingMicrophoneStatusSizeCheck;
  static_assert(sizeof(LivestreamingMicrophoneStatus) == 0x14);
}
