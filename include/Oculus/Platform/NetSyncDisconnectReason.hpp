...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NetSyncDisconnectReason), 16 + sizeof(int)> __Oculus_Platform_NetSyncDisconnectReasonSizeCheck;
  static_assert(sizeof(NetSyncDisconnectReason) == 0x14);
}
