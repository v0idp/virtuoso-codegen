...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ChallengeVisibility), 16 + sizeof(int)> __Oculus_Platform_ChallengeVisibilitySizeCheck;
  static_assert(sizeof(ChallengeVisibility) == 0x14);
}
