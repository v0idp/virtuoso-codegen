...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LivestreamingAudience), 16 + sizeof(int)> __Oculus_Platform_LivestreamingAudienceSizeCheck;
  static_assert(sizeof(LivestreamingAudience) == 0x14);
}
