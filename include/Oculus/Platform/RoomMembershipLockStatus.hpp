...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(RoomMembershipLockStatus), 16 + sizeof(int)> __Oculus_Platform_RoomMembershipLockStatusSizeCheck;
  static_assert(sizeof(RoomMembershipLockStatus) == 0x14);
}
