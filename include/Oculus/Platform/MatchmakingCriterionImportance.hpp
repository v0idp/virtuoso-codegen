...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MatchmakingCriterionImportance), 16 + sizeof(int)> __Oculus_Platform_MatchmakingCriterionImportanceSizeCheck;
  static_assert(sizeof(MatchmakingCriterionImportance) == 0x14);
}
