...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CloudStorageUpdateStatus), 16 + sizeof(int)> __Oculus_Platform_CloudStorageUpdateStatusSizeCheck;
  static_assert(sizeof(CloudStorageUpdateStatus) == 0x14);
}
