...
namespace Oculus::Platform::Models {
  ...
  class LeaderboardEntry : public ::Il2CppObject {
    ...
    // [ObsoleteAttribute] Offset: 0x6B93D8
    ...
    [[deprecated]] ::StringW& dyn_DisplayScore();
    ...
    [[deprecated]] ::Oculus::Platform::Models::SupplementaryMetric*& dyn_SupplementaryMetricOptional();
    // Get instance field reference: public readonly Oculus.Platform.Models.SupplementaryMetric SupplementaryMetric
    [[deprecated]] ::Oculus::Platform::Models::SupplementaryMetric*& dyn_SupplementaryMetric();
