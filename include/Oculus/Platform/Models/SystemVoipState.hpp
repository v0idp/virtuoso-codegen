...
namespace Oculus::Platform::Models {
  ...
  class SystemVoipState : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::Oculus::Platform::VoipMuteState) == 0x14);
    // public readonly Oculus.Platform.SystemVoipStatus Status
    // Size: 0x14
    // Offset: 0x14
    ::Oculus::Platform::SystemVoipStatus Status;
    // Field size check
    static_assert(sizeof(::Oculus::Platform::SystemVoipStatus) == 0x14);
    public:
  ...
  static_assert(sizeof(SystemVoipState) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
