...
namespace Oculus::Platform::Models {
  ...
  class Challenge : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::Oculus::Platform::ChallengeCreationType) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::Oculus::Platform::ChallengeVisibility) == 0x14);
    public:
  ...
  static_assert(sizeof(Challenge) == 0x7C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
