...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ChallengeViewerFilter), 16 + sizeof(int)> __Oculus_Platform_ChallengeViewerFilterSizeCheck;
  static_assert(sizeof(ChallengeViewerFilter) == 0x14);
}
