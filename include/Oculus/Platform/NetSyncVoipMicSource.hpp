...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NetSyncVoipMicSource), 16 + sizeof(int)> __Oculus_Platform_NetSyncVoipMicSourceSizeCheck;
  static_assert(sizeof(NetSyncVoipMicSource) == 0x14);
}
