...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LeaderboardFilterType), 16 + sizeof(int)> __Oculus_Platform_LeaderboardFilterTypeSizeCheck;
  static_assert(sizeof(LeaderboardFilterType) == 0x14);
}
