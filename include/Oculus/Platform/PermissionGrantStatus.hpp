...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PermissionGrantStatus), 16 + sizeof(int)> __Oculus_Platform_PermissionGrantStatusSizeCheck;
  static_assert(sizeof(PermissionGrantStatus) == 0x14);
}
