...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MatchmakingStatApproach), 16 + sizeof(int)> __Oculus_Platform_MatchmakingStatApproachSizeCheck;
  static_assert(sizeof(MatchmakingStatApproach) == 0x14);
}
