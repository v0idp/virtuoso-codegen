...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PlatformInitializeResult), 16 + sizeof(int)> __Oculus_Platform_PlatformInitializeResultSizeCheck;
  static_assert(sizeof(PlatformInitializeResult) == 0x14);
}
