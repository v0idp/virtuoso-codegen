...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CloudStorageDataStatus), 16 + sizeof(int)> __Oculus_Platform_CloudStorageDataStatusSizeCheck;
  static_assert(sizeof(CloudStorageDataStatus) == 0x14);
}
