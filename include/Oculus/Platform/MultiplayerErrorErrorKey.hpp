...
namespace Oculus::Platform {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MultiplayerErrorErrorKey), 16 + sizeof(int)> __Oculus_Platform_MultiplayerErrorErrorKeySizeCheck;
  static_assert(sizeof(MultiplayerErrorErrorKey) == 0x14);
}
