...
namespace RSG::Promises {
  ...
  class EnumerableExt::$FromItems$d__2_1 : public ::Il2CppObject/*, public ::System::Collections::Generic::IEnumerable_1<T>, public ::System::Collections::Generic::IEnumerator_1<T>*/ {
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<T>& dyn_$$3__items() {
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<T>& dyn_$$7__wrap1() {
    ...
    T System_Collections_Generic_IEnumerator$T$_get_Current() {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(this, classof(::RSG::Promises::EnumerableExt::$FromItems$d__2_1<T>*), -1));
