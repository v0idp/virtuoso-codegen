...
namespace RSG {
  ...
  class PromiseHelpers::$$c__DisplayClass0_0_2 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] T1& dyn_val1() {
    ...
    [[deprecated("Use field access instead!")]] int& dyn_numUnresolved() {
    ...
    [[deprecated("Use field access instead!")]] ::RSG::Promise_1<::RSG::Tuple_2<T1, T2>*>*& dyn_promise() {
    ...
    [[deprecated("Use field access instead!")]] T2& dyn_val2() {
    ...
    [[deprecated("Use field access instead!")]] bool& dyn_alreadyRejected() {
