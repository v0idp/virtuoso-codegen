...
namespace RSG {
  ...
  // Autogenerated type: RSG.Tuple`2
  ...
  class Tuple_2 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] T1& dyn_$Item1$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("::RSG::Tuple_2::dyn_$Item1$k__BackingField");
    ...
    [[deprecated("Use field access instead!")]] T2& dyn_$Item2$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("::RSG::Tuple_2::dyn_$Item2$k__BackingField");
      auto ___internal__instance = this;
    ...
    T1 get_Item1() {
      static auto ___internal__logger = ::Logger::get().WithContext("::RSG::Tuple_2::get_Item1");
    ...
    void set_Item1(T1 value) {
      static auto ___internal__logger = ::Logger::get().WithContext("::RSG::Tuple_2::set_Item1");
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    T2 get_Item2() {
      static auto ___internal__logger = ::Logger::get().WithContext("::RSG::Tuple_2::get_Item2");
    ...
    void set_Item2(T2 value) {
      static auto ___internal__logger = ::Logger::get().WithContext("::RSG::Tuple_2::set_Item2");
    ...
    // System.Void .ctor(T1 item1, T2 item2)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static Tuple_2<T1, T2>* New_ctor(T1 item1, T2 item2) {
      static auto ___internal__logger = ::Logger::get().WithContext("::RSG::Tuple_2::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Tuple_2<T1, T2>*, creationType>(item1, item2)));
    }
  }; // RSG.Tuple`2
  // Could not write size check! Type: RSG.Tuple`2 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
