...
namespace Newtonsoft::Json {
  ...
  // [NullableContextAttribute] Offset: 6725D0
  // [NullableAttribute] Offset: 6725D0
  class JsonSerializerSettings : public ::Il2CppObject {
    ...
    // [NullableAttribute] Offset: 0x674E34
    ...
    // [NullableAttribute] Offset: 0x674EC0
...
// Writing MetadataGetter for method: Newtonsoft::Json::JsonSerializerSettings::set_DateParseHandling
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::JsonSerializerSettings::*)(::Newtonsoft::Json::DateParseHandling)>(&Newtonsoft::Json::JsonSerializerSettings::set_DateParseHandling)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Newtonsoft::Json::JsonSerializerSettings*), "set_DateParseHandling", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
