...
namespace OVRSimpleJSON {
  ...
  struct JSONNode::Enumerator/*, public ::System::ValueType*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(JSONNode::Enumerator::Type), 16 + sizeof(int)> __OVRSimpleJSON_JSONNode_Enumerator_TypeSizeCheck;
    static_assert(sizeof(JSONNode::Enumerator::Type) == 0x14);
    public:
    ...
    // Field size check
    static_assert(sizeof(::OVRSimpleJSON::JSONNode::Enumerator::Type) == 0x14);
