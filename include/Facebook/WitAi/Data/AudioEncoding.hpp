...
namespace Facebook::WitAi::Data {
  ...
  class AudioEncoding : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(AudioEncoding::Endian), 16 + sizeof(int)> __Facebook_WitAi_Data_AudioEncoding_EndianSizeCheck;
    static_assert(sizeof(AudioEncoding::Endian) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::Facebook::WitAi::Data::AudioEncoding::Endian) == 0x14);
    public:
  ...
  static_assert(sizeof(AudioEncoding) == 0x34);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
