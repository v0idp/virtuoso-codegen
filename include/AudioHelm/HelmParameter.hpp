...
namespace AudioHelm {
  ...
  class HelmParameter : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(HelmParameter::ScaleType), 16 + sizeof(int)> __AudioHelm_HelmParameter_ScaleTypeSizeCheck;
    static_assert(sizeof(HelmParameter::ScaleType) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::AudioHelm::HelmParameter::ScaleType) == 0x14);
