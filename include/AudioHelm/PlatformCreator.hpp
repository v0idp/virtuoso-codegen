...
namespace AudioHelm {
  ...
  // [AddComponentMenu] Offset: 66C220
  class PlatformCreator : public ::UnityEngine::MonoBehaviour {
    ...
    ::UnityEngine::Transform*& dyn_platformModel();
