...
namespace AudioHelm {
  ...
  class Sequencer : public ::UnityEngine::MonoBehaviour/*, public ::AudioHelm::NoteHandler, public ::UnityEngine::ISerializationCallbackReceiver*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(Sequencer::Division), 16 + sizeof(int)> __AudioHelm_Sequencer_DivisionSizeCheck;
    static_assert(sizeof(Sequencer::Division) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::AudioHelm::Sequencer::Division) == 0x14);
