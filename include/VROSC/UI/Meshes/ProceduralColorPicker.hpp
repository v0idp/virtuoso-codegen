...
namespace VROSC::UI::Meshes {
  ...
  // [CreateAssetMenuAttribute] Offset: 66B3FC
  class ProceduralColorPicker : public ::VROSC::UI::Meshes::ProceduralMeshData {
    ...
    // [RangeAttribute] Offset: 0x677790
    ...
    // [RangeAttribute] Offset: 0x6777D0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0x677810
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0x677850
