...
namespace VROSC {
  ...
  class DirectionalFilter : public ::VROSC::SignalFilter {
    ...
    #pragma pack(pop)
    static check_size<sizeof(DirectionalFilter::Space), 16 + sizeof(int)> __VROSC_DirectionalFilter_SpaceSizeCheck;
    static_assert(sizeof(DirectionalFilter::Space) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::DirectionalFilter::Space) == 0x14);
