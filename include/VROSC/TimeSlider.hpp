...
namespace VROSC {
  ...
  class TimeSlider : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(TimeSlider::SourceType), 16 + sizeof(int)> __VROSC_TimeSlider_SourceTypeSizeCheck;
    static_assert(sizeof(TimeSlider::SourceType) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::TimeSlider::SourceType) == 0x14);
