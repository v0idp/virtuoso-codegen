...
namespace VROSC {
  ...
  class CurrentMidiInterfaceFilter : public ::VROSC::SignalFilter {
    ...
    #pragma pack(pop)
    static check_size<sizeof(CurrentMidiInterfaceFilter::MidiInterfaceType), 16 + sizeof(int)> __VROSC_CurrentMidiInterfaceFilter_MidiInterfaceTypeSizeCheck;
    static_assert(sizeof(CurrentMidiInterfaceFilter::MidiInterfaceType) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::CurrentMidiInterfaceFilter::MidiInterfaceType) == 0x14);
    public:
  ...
  static_assert(sizeof(CurrentMidiInterfaceFilter) == 0x54);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
