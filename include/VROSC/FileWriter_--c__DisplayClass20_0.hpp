...
namespace VROSC {
  ...
  #pragma pack(pop)
  static check_size<sizeof(FileWriter::$$c__DisplayClass20_0), 56 + sizeof(::StringW)> __VROSC_FileWriter_$$c__DisplayClass20_0SizeCheck;
  static_assert(sizeof(FileWriter::$$c__DisplayClass20_0) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: VROSC::FileWriter::$$c__DisplayClass20_0::$ExportTapeRecording$b__0
// Il2CppName: <ExportTapeRecording>b__0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::FileWriter::$$c__DisplayClass20_0::*)()>(&VROSC::FileWriter::$$c__DisplayClass20_0::$ExportTapeRecording$b__0)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(VROSC::FileWriter::$$c__DisplayClass20_0*), "<ExportTapeRecording>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
