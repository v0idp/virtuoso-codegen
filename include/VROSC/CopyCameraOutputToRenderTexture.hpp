...
namespace VROSC {
  ...
  class CopyCameraOutputToRenderTexture : public ::UnityEngine::MonoBehaviour {
    ...
    // private System.Boolean _menuOpen
    // Size: 0x1
    // Offset: 0x31
    bool menuOpen;
    // Field size check
    ...
    ::UnityEngine::RenderTexture*& dyn__output();
    // Get instance field reference: private UnityEngine.Material _instancedMaterial
    ::UnityEngine::Material*& dyn__instancedMaterial();
    // Get instance field reference: private System.Boolean _active
    bool& dyn__active();
    // Get instance field reference: private System.Boolean _menuOpen
    bool& dyn__menuOpen();
  ...
  #pragma pack(pop)
  static check_size<sizeof(CopyCameraOutputToRenderTexture), 50 + sizeof(bool)> __VROSC_CopyCameraOutputToRenderTextureSizeCheck;
  static_assert(sizeof(CopyCameraOutputToRenderTexture) == 0x33);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::CopyCameraOutputToRenderTexture::*)(bool)>(&VROSC::CopyCameraOutputToRenderTexture::SetActive)> {
  static const MethodInfo* get() {
    static auto* active = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(VROSC::CopyCameraOutputToRenderTexture*), "SetActive", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{active});
  }
};
// Writing MetadataGetter for method: VROSC::CopyCameraOutputToRenderTexture::SetMenuOpen
// Il2CppName: SetMenuOpen
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::CopyCameraOutputToRenderTexture::*)(bool)>(&VROSC::CopyCameraOutputToRenderTexture::SetMenuOpen)> {
  static const MethodInfo* get() {
    static auto* menuOpen = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(VROSC::CopyCameraOutputToRenderTexture*), "SetMenuOpen", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{menuOpen});
  }
};
