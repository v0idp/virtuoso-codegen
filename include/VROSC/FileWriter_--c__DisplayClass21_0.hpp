...
namespace VROSC {
  ...
  #pragma pack(pop)
  static check_size<sizeof(FileWriter::$$c__DisplayClass21_0), 48 + sizeof(int)> __VROSC_FileWriter_$$c__DisplayClass21_0SizeCheck;
  static_assert(sizeof(FileWriter::$$c__DisplayClass21_0) == 0x34);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: VROSC::FileWriter::$$c__DisplayClass21_0::$SaveAudioToFile$b__0
// Il2CppName: <SaveAudioToFile>b__0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::FileWriter::$$c__DisplayClass21_0::*)()>(&VROSC::FileWriter::$$c__DisplayClass21_0::$SaveAudioToFile$b__0)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(VROSC::FileWriter::$$c__DisplayClass21_0*), "<SaveAudioToFile>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
