...
namespace VROSC {
  ...
  class WidgetSettings : public ::UnityEngine::ScriptableObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(WidgetSettings::Identifier), 16 + sizeof(int)> __VROSC_WidgetSettings_IdentifierSizeCheck;
    static_assert(sizeof(WidgetSettings::Identifier) == 0x14);
