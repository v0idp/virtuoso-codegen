...
namespace VROSC {
  ...
  class SessionsItemsContainer : public ::UnityEngine::MonoBehaviour {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::List_1<::StringW>*& dyn__currentFilterWords();
    // Get instance field reference: private VROSC.SessionsLibraryUI/VROSC.OrderingType _orderingType
    [[deprecated("Use field access instead!")]] ::VROSC::SessionsLibraryUI::OrderingType& dyn__orderingType();
    // Get instance field reference: private VROSC.SessionsLibraryUI/VROSC.OrderingDirection _orderingDirection
    [[deprecated("Use field access instead!")]] ::VROSC::SessionsLibraryUI::OrderingDirection& dyn__orderingDirection();
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::List_1<::VROSC::SessionItemData*>*& dyn_$SessionItems$k__BackingField();
    // Get instance field reference: public System.Action`1<VROSC.SessionItemData> OnDataSelected
    [[deprecated("Use field access instead!")]] ::System::Action_1<::VROSC::SessionItemData*>*& dyn_OnDataSelected();
