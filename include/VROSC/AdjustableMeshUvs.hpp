...
namespace VROSC {
  ...
  class AdjustableMeshUvs : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(AdjustableMeshUvs::Channel), 16 + sizeof(int)> __VROSC_AdjustableMeshUvs_ChannelSizeCheck;
    static_assert(sizeof(AdjustableMeshUvs::Channel) == 0x14);
