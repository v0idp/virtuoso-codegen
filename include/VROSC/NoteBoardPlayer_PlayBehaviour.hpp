...
namespace VROSC {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NoteBoardPlayer::PlayBehaviour), 16 + sizeof(int)> __VROSC_NoteBoardPlayer_PlayBehaviourSizeCheck;
  static_assert(sizeof(NoteBoardPlayer::PlayBehaviour) == 0x14);
}
