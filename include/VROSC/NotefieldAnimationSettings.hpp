...
namespace VROSC {
  ...
  // [CreateAssetMenuAttribute] Offset: 669AEC
  class NotefieldAnimationSettings : public ::UnityEngine::ScriptableObject {
    ...
    #endif
    #endif
    // [HeaderAttribute] Offset: 0x66FD6C
    ...
    char __padding9[0x3] = {};
    // [HeaderAttribute] Offset: 0x66FE48
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [BitMaskAttribute] Offset: 0x66FEB4
    ...
    ::VROSC::NotefieldAnimationSettings::TimelineSettings*& dyn__creation();
    // Get instance field reference: private VROSC.NotefieldAnimationSettings/VROSC.TimelineSettings _destruction
    ::VROSC::NotefieldAnimationSettings::TimelineSettings*& dyn__destruction();
  ...
  static_assert(sizeof(NotefieldAnimationSettings) == 0x7C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
