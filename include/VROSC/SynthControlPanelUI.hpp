...
namespace VROSC {
  ...
  class SynthControlPanelUI : public ::VROSC::InstrumentControlPanelUI {
    ...
    ::VROSC::UIToggle*& dyn__scalePanelButton();
    // Get instance field reference: private VROSC.UIToggle _effectsPanelButton
    ::VROSC::UIToggle*& dyn__effectsPanelButton();
  ...
  #pragma pack(pop)
  static check_size<sizeof(SynthControlPanelUI), 120 + sizeof(::VROSC::UIToggle*)> __VROSC_SynthControlPanelUISizeCheck;
  static_assert(sizeof(SynthControlPanelUI) == 0x80);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
