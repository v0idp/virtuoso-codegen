...
namespace VROSC {
  ...
  class VRPlayer : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(VRPlayer::ControllerType), 16 + sizeof(int)> __VROSC_VRPlayer_ControllerTypeSizeCheck;
    static_assert(sizeof(VRPlayer::ControllerType) == 0x14);
  ...
  static_assert(sizeof(VRPlayer) == 0xB4);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
