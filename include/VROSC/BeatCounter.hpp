...
namespace VROSC {
  ...
  class BeatCounter : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(BeatCounter::SyncSource), 16 + sizeof(int)> __VROSC_BeatCounter_SyncSourceSizeCheck;
    static_assert(sizeof(BeatCounter::SyncSource) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::BeatCounter::SyncSource) == 0x14);
