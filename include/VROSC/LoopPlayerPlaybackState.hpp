...
namespace VROSC {
  ...
  class LoopPlayerPlaybackState : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(LoopPlayerPlaybackState::Activity), 16 + sizeof(int)> __VROSC_LoopPlayerPlaybackState_ActivitySizeCheck;
    static_assert(sizeof(LoopPlayerPlaybackState::Activity) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::LoopPlayerPlaybackState::Activity) == 0x14);
