...
namespace VROSC {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BeatCounterUI::SyncToggleSource), 16 + sizeof(int)> __VROSC_BeatCounterUI_SyncToggleSourceSizeCheck;
  static_assert(sizeof(BeatCounterUI::SyncToggleSource) == 0x14);
}
