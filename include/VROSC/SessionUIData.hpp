...
namespace VROSC {
  ...
  class SessionUIData : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(SessionUIData::Type), 16 + sizeof(int)> __VROSC_SessionUIData_TypeSizeCheck;
    static_assert(sizeof(SessionUIData::Type) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::SessionUIData::Type) == 0x14);
