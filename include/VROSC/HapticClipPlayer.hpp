...
namespace VROSC {
  ...
  class HapticClipPlayer : public ::VROSC::SignalNode {
    ...
    #pragma pack(pop)
    static check_size<sizeof(HapticClipPlayer::HapticHand), 16 + sizeof(int)> __VROSC_HapticClipPlayer_HapticHandSizeCheck;
    static_assert(sizeof(HapticClipPlayer::HapticHand) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::HapticClipPlayer::HapticHand) == 0x14);
  ...
  static_assert(sizeof(HapticClipPlayer) == 0x78);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
