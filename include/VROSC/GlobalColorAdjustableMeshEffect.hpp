...
namespace VROSC {
  ...
  class GlobalColorAdjustableMeshEffect : public ::VROSC::AdjustableMeshEffect {
    ...
    #pragma pack(pop)
    static check_size<sizeof(GlobalColorAdjustableMeshEffect::Channel), 16 + sizeof(int)> __VROSC_GlobalColorAdjustableMeshEffect_ChannelSizeCheck;
    static_assert(sizeof(GlobalColorAdjustableMeshEffect::Channel) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::GlobalColorAdjustableMeshEffect::Channel) == 0x14);
