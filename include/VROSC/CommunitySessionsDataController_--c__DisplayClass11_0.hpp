...
NEED_NO_BOX(::VROSC::CommunitySessionsDataController::$$c__DisplayClass11_0);
DEFINE_IL2CPP_ARG_TYPE(::VROSC::CommunitySessionsDataController::$$c__DisplayClass11_0*, "VROSC", "CommunitySessionsDataController/<>c__DisplayClass11_0");
// Type namespace: VROSC
namespace VROSC {
  // Size: 0x20
  #pragma pack(push, 1)
  // Autogenerated type: VROSC.CommunitySessionsDataController/VROSC.<>c__DisplayClass11_0
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  class CommunitySessionsDataController::$$c__DisplayClass11_0 : public ::Il2CppObject {
    public:
    public:
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::CommunitySessionsDataController::$$c__DisplayClass11_0::*)(::StringW)>(&VROSC::CommunitySessionsDataController::$$c__DisplayClass11_0::$AddSessionPreviewPlay$b__0)> {
