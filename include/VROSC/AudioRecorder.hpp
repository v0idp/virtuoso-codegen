...
namespace VROSC {
  ...
  class AudioRecorder : public ::UnityEngine::MonoBehaviour {
    ...
    [[deprecated("Use field access instead!")]] ::VROSC::HelmRecorder*& dyn__helmRecorder();
    // Get instance field reference: private VROSC.MicrophoneRecorder _microphoneRecorder
    [[deprecated("Use field access instead!")]] ::VROSC::MicrophoneRecorder*& dyn__microphoneRecorder();
    // Get instance field reference: private VROSC.MixerGroupRecorder _samplerRecorder
    [[deprecated("Use field access instead!")]] ::VROSC::MixerGroupRecorder*& dyn__samplerRecorder();
    // Get instance field reference: private VROSC.MasterRecorder _masterRecorder
    [[deprecated("Use field access instead!")]] ::VROSC::MasterRecorder*& dyn__masterRecorder();
