...
NEED_NO_BOX(::VROSC::AnimatedAppearData::AdjustableMeshAppear);
DEFINE_IL2CPP_ARG_TYPE(::VROSC::AnimatedAppearData::AdjustableMeshAppear*, "VROSC", "AnimatedAppearData/AdjustableMeshAppear");
// Type namespace: VROSC
namespace VROSC {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: VROSC.AnimatedAppearData/VROSC.AdjustableMeshAppear
  ...
  }; // VROSC.AnimatedAppearData/VROSC.AdjustableMeshAppear
  #pragma pack(pop)
  static check_size<sizeof(AnimatedAppearData::AdjustableMeshAppear), 32 + sizeof(::VROSC::AdjustableMesh*)> __VROSC_AnimatedAppearData_AdjustableMeshAppearSizeCheck;
  static_assert(sizeof(AnimatedAppearData::AdjustableMeshAppear) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: VROSC::AnimatedAppearData::AdjustableMeshAppear::New_ctor
// Il2CppName: .ctor
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: VROSC::AnimatedAppearData::AdjustableMeshAppear::UpdateObject
// Il2CppName: UpdateObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::AnimatedAppearData::AdjustableMeshAppear::*)(::VROSC::AnimatedAppear::Mode, bool)>(&VROSC::AnimatedAppearData::AdjustableMeshAppear::UpdateObject)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(VROSC::AnimatedAppearData::AdjustableMeshAppear*), "UpdateObject", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{mode, useFlash});
  }
};
