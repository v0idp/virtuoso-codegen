...
namespace VROSC {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NetNoteboard), 136 + sizeof(float)> __VROSC_NetNoteboardSizeCheck;
  static_assert(sizeof(NetNoteboard) == 0x8C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
