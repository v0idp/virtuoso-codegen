...
namespace VROSC {
  // Forward declaring type: Decrement
  class Decrement;
}
...
namespace VROSC {
  // Size: 0x50
  #pragma pack(push, 1)
  // Autogenerated type: VROSC.Decrement
  // [TokenAttribute] Offset: FFFFFFFF
  class Decrement : public ::VROSC::IntChanger {
    public:
    ...
    static Decrement* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<Decrement*, creationType>()));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(Decrement), 76 + sizeof(int)> __VROSC_DecrementSizeCheck;
  static_assert(sizeof(Decrement) == 0x50);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: VROSC::Decrement::New_ctor
// Il2CppName: .ctor
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: VROSC::Decrement::SetValueBySignal
// Il2CppName: SetValueBySignal
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::Decrement::*)(::VROSC::Signal*)>(&VROSC::Decrement::SetValueBySignal)> {
  static const MethodInfo* get() {
    static auto* signal = &::il2cpp_utils::GetClassFromName("VROSC", "Signal")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(VROSC::Decrement*), "SetValueBySignal", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{signal});
  }
};
