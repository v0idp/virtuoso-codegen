...
namespace VROSC {
  ...
  class GlobalColorSetParticleStartColor : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(GlobalColorSetParticleStartColor::Channel), 16 + sizeof(int)> __VROSC_GlobalColorSetParticleStartColor_ChannelSizeCheck;
    static_assert(sizeof(GlobalColorSetParticleStartColor::Channel) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::GlobalColorSetParticleStartColor::Channel) == 0x14);
