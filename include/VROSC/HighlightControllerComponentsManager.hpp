...
namespace VROSC {
  ...
  class HighlightControllerComponentsManager : public ::UnityEngine::MonoBehaviour {
    ...
    [[deprecated("Use field access instead!")]] ::VROSC::HighlightControllerComponents*& dyn__left();
    // Get instance field reference: private VROSC.HighlightControllerComponents _right
    [[deprecated("Use field access instead!")]] ::VROSC::HighlightControllerComponents*& dyn__right();
