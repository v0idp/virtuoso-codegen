...
namespace VROSC {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SynthParameterController::TargetParameter), 16 + sizeof(int)> __VROSC_SynthParameterController_TargetParameterSizeCheck;
  static_assert(sizeof(SynthParameterController::TargetParameter) == 0x14);
}
