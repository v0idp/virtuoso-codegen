...
namespace VROSC {
  ...
  class CloudStateManager : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(CloudStateManager::DownloadState), 16 + sizeof(int)> __VROSC_CloudStateManager_DownloadStateSizeCheck;
    static_assert(sizeof(CloudStateManager::DownloadState) == 0x14);
    // Size: 0x14
    #pragma pack(push, 1)
    ...
    #pragma pack(pop)
    static check_size<sizeof(CloudStateManager::UploadState), 16 + sizeof(int)> __VROSC_CloudStateManager_UploadStateSizeCheck;
    static_assert(sizeof(CloudStateManager::UploadState) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::CloudStateManager::DownloadState) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::CloudStateManager::UploadState) == 0x14);
    public:
  ...
  static_assert(sizeof(CloudStateManager) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
