...
NEED_NO_BOX(::VROSC::SynthsDataController::$$c__DisplayClass6_2);
DEFINE_IL2CPP_ARG_TYPE(::VROSC::SynthsDataController::$$c__DisplayClass6_2*, "VROSC", "SynthsDataController/<>c__DisplayClass6_2");
// Type namespace: VROSC
namespace VROSC {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: VROSC.SynthsDataController/VROSC.<>c__DisplayClass6_2
  ...
  class SynthsDataController::$$c__DisplayClass6_2 : public ::Il2CppObject {
    ...
    // Size: 0x8
    // Offset: 0x10
    ::VROSC::SynthData* instrumentData;
    // Field size check
    static_assert(sizeof(::VROSC::SynthData*) == 0x8);
    // public VROSC.SynthsDataController/VROSC.<>c__DisplayClass6_1 CS$<>8__locals2
    // Size: 0x8
    // Offset: 0x18
    ::VROSC::SynthsDataController::$$c__DisplayClass6_1* CS$$$8__locals2;
    // Field size check
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::SynthsDataController::$$c__DisplayClass6_2::*)(::StringW)>(&VROSC::SynthsDataController::$$c__DisplayClass6_2::$LoadData$b__1)> {
