...
namespace VROSC {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SynthController), 240 + sizeof(bool)> __VROSC_SynthControllerSizeCheck;
  static_assert(sizeof(SynthController) == 0xF1);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: VROSC::SynthController::ResetWidget
// Il2CppName: ResetWidget
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::SynthController::*)()>(&VROSC::SynthController::ResetWidget)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(VROSC::SynthController*), "ResetWidget", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
