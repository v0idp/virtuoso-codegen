...
namespace VROSC {
  ...
  class PlatformSelector : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(PlatformSelector::Platform), 16 + sizeof(int)> __VROSC_PlatformSelector_PlatformSizeCheck;
    static_assert(sizeof(PlatformSelector::Platform) == 0x14);
