...
namespace VROSC {
  ...
  class IntNode : public ::VROSC::Node {
    ...
    #pragma pack(pop)
    static check_size<sizeof(IntNode::OverflowBehaviour), 16 + sizeof(int)> __VROSC_IntNode_OverflowBehaviourSizeCheck;
    static_assert(sizeof(IntNode::OverflowBehaviour) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::IntNode::OverflowBehaviour) == 0x14);
