...
namespace VROSC {
  ...
  class InternalSynthesizer : public ::UnityEngine::MonoBehaviour {
    public:
    // Nested type: ::VROSC::InternalSynthesizer::$Setup$d__10
    struct $Setup$d__10;
    public:
    ...
    // private VROSC.HelmWrapper _helmOne
    // Size: 0x8
    // Offset: 0x28
    ::VROSC::HelmWrapper* helmOne;
    // Field size check
    static_assert(sizeof(::VROSC::HelmWrapper*) == 0x8);
    // private VROSC.HelmWrapper _helmTwo
    // Size: 0x8
    // Offset: 0x30
    ::VROSC::HelmWrapper* helmTwo;
    // Field size check
    static_assert(sizeof(::VROSC::HelmWrapper*) == 0x8);
    // private System.Collections.Generic.List`1<VROSC.HelmWrapper> _helms
    // Size: 0x8
    // Offset: 0x38
    ::System::Collections::Generic::List_1<::VROSC::HelmWrapper*>* helms;
    // Field size check
    static_assert(sizeof(::System::Collections::Generic::List_1<::VROSC::HelmWrapper*>*) == 0x8);
