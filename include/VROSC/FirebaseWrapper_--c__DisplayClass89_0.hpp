...
NEED_NO_BOX(::VROSC::FirebaseWrapper::$$c__DisplayClass89_0);
DEFINE_IL2CPP_ARG_TYPE(::VROSC::FirebaseWrapper::$$c__DisplayClass89_0*, "VROSC", "FirebaseWrapper/<>c__DisplayClass89_0");
// Type namespace: VROSC
namespace VROSC {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: VROSC.FirebaseWrapper/VROSC.<>c__DisplayClass89_0
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  class FirebaseWrapper::$$c__DisplayClass89_0 : public ::Il2CppObject {
    public:
    public:
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::FirebaseWrapper::$$c__DisplayClass89_0::*)(::Proyecto26::ResponseHelper*)>(&VROSC::FirebaseWrapper::$$c__DisplayClass89_0::$GetForceUpdates$b__0)> {
  static const MethodInfo* get() {
    static auto* response = &::il2cpp_utils::GetClassFromName("Proyecto26", "ResponseHelper")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(VROSC::FirebaseWrapper::$$c__DisplayClass89_0*), "<GetForceUpdates>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{response});
  }
};
// Writing MetadataGetter for method: VROSC::FirebaseWrapper::$$c__DisplayClass89_0::$GetForceUpdates$b__1
// Il2CppName: <GetForceUpdates>b__1
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::FirebaseWrapper::$$c__DisplayClass89_0::*)(::System::Exception*)>(&VROSC::FirebaseWrapper::$$c__DisplayClass89_0::$GetForceUpdates$b__1)> {
  static const MethodInfo* get() {
