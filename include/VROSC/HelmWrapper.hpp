...
namespace VROSC {
  ...
  // [RequireComponent] Offset: 668780
  // [RequireComponent] Offset: 668780
  class HelmWrapper : public ::VROSC::AudioHelmInstrumentWrapper {
    ...
    ::AudioHelm::HelmController*& dyn__helmController();
    // Get instance field reference: private AudioHelm.HelmPatch _helmPatch
    ::AudioHelm::HelmPatch*& dyn__helmPatch();
  ...
  #pragma pack(pop)
  static check_size<sizeof(HelmWrapper), 40 + sizeof(::VROSC::PatchSettings*)> __VROSC_HelmWrapperSizeCheck;
  static_assert(sizeof(HelmWrapper) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
