...
namespace VROSC {
  ...
  class SessionsLibraryUI : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(SessionsLibraryUI::State), 16 + sizeof(int)> __VROSC_SessionsLibraryUI_StateSizeCheck;
    static_assert(sizeof(SessionsLibraryUI::State) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::SessionsLibraryUI::State) == 0x14);
