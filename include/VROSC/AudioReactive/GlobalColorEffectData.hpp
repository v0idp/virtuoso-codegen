...
namespace VROSC::AudioReactive {
  ...
  class GlobalColorEffectData : public ::VROSC::AudioReactive::AudioReactiveEffectData {
    ...
    #pragma pack(pop)
    static check_size<sizeof(GlobalColorEffectData::OnBeatBehaviour), 16 + sizeof(int)> __VROSC_AudioReactive_GlobalColorEffectData_OnBeatBehaviourSizeCheck;
    static_assert(sizeof(GlobalColorEffectData::OnBeatBehaviour) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::AudioReactive::GlobalColorEffectData::OnBeatBehaviour) == 0x14);
