...
namespace VROSC::AudioReactive {
  ...
  class ReactToBeat : public ::VROSC::AudioReactive::AudioReactiveBehaviour {
    ...
    class ReactToBeatEffect : public ::Il2CppObject {
      ...
      #pragma pack(pop)
      static check_size<sizeof(ReactToBeat::ReactToBeatEffect::Type), 16 + sizeof(int)> __VROSC_AudioReactive_ReactToBeat_ReactToBeatEffect_TypeSizeCheck;
      static_assert(sizeof(ReactToBeat::ReactToBeatEffect::Type) == 0x14);
      ...
      // Field size check
      static_assert(sizeof(::VROSC::AudioReactive::ReactToBeat::ReactToBeatEffect::Type) == 0x14);
      public:
    ...
    static_assert(sizeof(ReactToBeat::ReactToBeatEffect) == 0x74);
    #ifdef USE_CODEGEN_FIELDS
    public:
    #else
    #ifdef CODEGEN_FIELD_ACCESSIBILITY
