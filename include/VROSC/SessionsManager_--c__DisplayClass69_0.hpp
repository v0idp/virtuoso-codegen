...
namespace VROSC {
  ...
  class SessionsManager::$$c__DisplayClass69_0 : public ::Il2CppObject {
    ...
    // System.Void <AddSessionDownload>b__1(System.String downloadId)
    // Offset: 0x134CD08
    void $AddSessionDownload$b__1(::StringW downloadId);
    // System.Void <AddSessionDownload>b__2(VROSC.Error error)
    // Offset: 0x134CD94
    void $AddSessionDownload$b__2(::VROSC::Error error);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::SessionsManager::$$c__DisplayClass69_0::*)(::StringW)>(&VROSC::SessionsManager::$$c__DisplayClass69_0::$AddSessionDownload$b__1)> {
  static const MethodInfo* get() {
    static auto* downloadId = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(VROSC::SessionsManager::$$c__DisplayClass69_0*), "<AddSessionDownload>b__1", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{downloadId});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::SessionsManager::$$c__DisplayClass69_0::*)(::VROSC::Error)>(&VROSC::SessionsManager::$$c__DisplayClass69_0::$AddSessionDownload$b__2)> {
  static const MethodInfo* get() {
    static auto* error = &::il2cpp_utils::GetClassFromName("VROSC", "Error")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(VROSC::SessionsManager::$$c__DisplayClass69_0*), "<AddSessionDownload>b__2", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{error});
  }
};
