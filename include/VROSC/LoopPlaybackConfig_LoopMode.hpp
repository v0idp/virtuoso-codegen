...
namespace VROSC {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LoopPlaybackConfig::LoopMode), 16 + sizeof(int)> __VROSC_LoopPlaybackConfig_LoopModeSizeCheck;
  static_assert(sizeof(LoopPlaybackConfig::LoopMode) == 0x14);
}
