...
namespace VROSC {
  ...
  class SpectatorCameraAnchor : public ::UnityEngine::MonoBehaviour {
    ...
    // Offset: 0x13BA93C
    void Update();
    // System.Void SetActive(UnityEngine.Camera spectatorCamera, System.Boolean hideBackground)
    // Offset: 0x13BAB68
    void SetActive(::UnityEngine::Camera* spectatorCamera, bool hideBackground);
  ...
  #pragma pack(pop)
  static check_size<sizeof(SpectatorCameraAnchor), 64 + sizeof(float)> __VROSC_SpectatorCameraAnchorSizeCheck;
  static_assert(sizeof(SpectatorCameraAnchor) == 0x44);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (VROSC::SpectatorCameraAnchor::*)(::UnityEngine::Camera*, bool)>(&VROSC::SpectatorCameraAnchor::SetActive)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(VROSC::SpectatorCameraAnchor*), "SetActive", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{spectatorCamera, hideBackground});
  }
};
