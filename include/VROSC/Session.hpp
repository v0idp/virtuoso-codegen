...
namespace VROSC {
  ...
  class Session : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(Session::PreviewSource), 16 + sizeof(int)> __VROSC_Session_PreviewSourceSizeCheck;
    static_assert(sizeof(Session::PreviewSource) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::VROSC::Session::PreviewSource) == 0x14);
