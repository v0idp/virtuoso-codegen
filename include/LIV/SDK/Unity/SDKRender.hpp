...
namespace LIV::SDK::Unity {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SDKRender), 840 + sizeof(int)> __LIV_SDK_Unity_SDKRenderSizeCheck;
  static_assert(sizeof(SDKRender) == 0x34C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: LIV::SDK::Unity::SDKRender::get_BackgroundRenderTexture
// Il2CppName: get_BackgroundRenderTexture
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::RenderTexture* (LIV::SDK::Unity::SDKRender::*)()>(&LIV::SDK::Unity::SDKRender::get_BackgroundRenderTexture)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(LIV::SDK::Unity::SDKRender*), "get_BackgroundRenderTexture", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
