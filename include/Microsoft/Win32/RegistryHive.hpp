...
namespace Microsoft::Win32 {
  ...
  // [ComVisibleAttribute] Offset: 577DBC
  ...
  #pragma pack(pop)
  static check_size<sizeof(RegistryHive), 16 + sizeof(int)> __Microsoft_Win32_RegistryHiveSizeCheck;
  static_assert(sizeof(RegistryHive) == 0x14);
}
