...
namespace Microsoft::Win32 {
  ...
  // [ComVisibleAttribute] Offset: 577DE4
  ...
  #pragma pack(pop)
  static check_size<sizeof(RegistryValueKind), 16 + sizeof(int)> __Microsoft_Win32_RegistryValueKindSizeCheck;
  static_assert(sizeof(RegistryValueKind) == 0x14);
}
