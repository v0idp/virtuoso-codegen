...
namespace Microsoft::Win32 {
  ...
  #pragma pack(pop)
  static check_size<sizeof(RegistryValueOptions), 16 + sizeof(int)> __Microsoft_Win32_RegistryValueOptionsSizeCheck;
  static_assert(sizeof(RegistryValueOptions) == 0x14);
}
