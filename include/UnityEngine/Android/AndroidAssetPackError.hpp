...
namespace UnityEngine::Android {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AndroidAssetPackError), 16 + sizeof(int)> __UnityEngine_Android_AndroidAssetPackErrorSizeCheck;
  static_assert(sizeof(AndroidAssetPackError) == 0x14);
}
