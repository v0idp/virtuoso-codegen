...
namespace UnityEngine::Experimental::Rendering {
  ...
  #pragma pack(pop)
  static check_size<sizeof(DefaultFormat), 16 + sizeof(int)> __UnityEngine_Experimental_Rendering_DefaultFormatSizeCheck;
  static_assert(sizeof(DefaultFormat) == 0x14);
}
