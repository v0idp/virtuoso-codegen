...
namespace UnityEngine::Experimental::Rendering {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TextureCreationFlags), 16 + sizeof(int)> __UnityEngine_Experimental_Rendering_TextureCreationFlagsSizeCheck;
  static_assert(sizeof(TextureCreationFlags) == 0x14);
}
