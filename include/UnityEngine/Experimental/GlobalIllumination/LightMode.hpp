...
namespace UnityEngine::Experimental::GlobalIllumination {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LightMode), 16 + sizeof(uint8_t)> __UnityEngine_Experimental_GlobalIllumination_LightModeSizeCheck;
  static_assert(sizeof(LightMode) == 0x11);
}
