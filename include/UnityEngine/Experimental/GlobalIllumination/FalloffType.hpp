...
namespace UnityEngine::Experimental::GlobalIllumination {
  ...
  #pragma pack(pop)
  static check_size<sizeof(FalloffType), 16 + sizeof(uint8_t)> __UnityEngine_Experimental_GlobalIllumination_FalloffTypeSizeCheck;
  static_assert(sizeof(FalloffType) == 0x11);
}
