...
namespace UnityEngine::Experimental::GlobalIllumination {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LightType), 16 + sizeof(uint8_t)> __UnityEngine_Experimental_GlobalIllumination_LightTypeSizeCheck;
  static_assert(sizeof(LightType) == 0x11);
}
