...
namespace UnityEngine::Experimental::GlobalIllumination {
  ...
  struct SpotLight/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::LightMode) == 0x11);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::FalloffType) == 0x11);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Experimental::GlobalIllumination::AngularFalloffType) == 0x11);
    public:
  ...
  static_assert(sizeof(SpotLight) == 0x66);
}
