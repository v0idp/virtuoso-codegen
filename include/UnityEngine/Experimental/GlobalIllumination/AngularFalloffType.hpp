...
namespace UnityEngine::Experimental::GlobalIllumination {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AngularFalloffType), 16 + sizeof(uint8_t)> __UnityEngine_Experimental_GlobalIllumination_AngularFalloffTypeSizeCheck;
  static_assert(sizeof(AngularFalloffType) == 0x11);
}
