...
namespace UnityEngine::Experimental::TerrainAPI {
  ...
  class TerrainUtility::TerrainMap : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(TerrainUtility::TerrainMap::ErrorCode), 16 + sizeof(int)> __UnityEngine_Experimental_TerrainAPI_TerrainUtility_TerrainMap_ErrorCodeSizeCheck;
    static_assert(sizeof(TerrainUtility::TerrainMap::ErrorCode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Experimental::TerrainAPI::TerrainUtility::TerrainMap::ErrorCode) == 0x14);
