...
namespace UnityEngine {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 5C86A4
  ...
  #pragma pack(pop)
  static check_size<sizeof(RemoteConfigSettingsHelper::Tag), 16 + sizeof(int)> __UnityEngine_RemoteConfigSettingsHelper_TagSizeCheck;
  static_assert(sizeof(RemoteConfigSettingsHelper::Tag) == 0x14);
}
