...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ParticleSystemGradientMode), 16 + sizeof(int)> __UnityEngine_ParticleSystemGradientModeSizeCheck;
  static_assert(sizeof(ParticleSystemGradientMode) == 0x14);
}
