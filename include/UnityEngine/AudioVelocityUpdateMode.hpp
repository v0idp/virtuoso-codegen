...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AudioVelocityUpdateMode), 16 + sizeof(int)> __UnityEngine_AudioVelocityUpdateModeSizeCheck;
  static_assert(sizeof(AudioVelocityUpdateMode) == 0x14);
}
