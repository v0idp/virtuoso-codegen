...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AdditionalCanvasShaderChannels), 16 + sizeof(int)> __UnityEngine_AdditionalCanvasShaderChannelsSizeCheck;
  static_assert(sizeof(AdditionalCanvasShaderChannels) == 0x14);
}
