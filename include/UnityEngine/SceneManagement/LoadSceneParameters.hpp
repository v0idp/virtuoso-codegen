...
namespace UnityEngine::SceneManagement {
  ...
  struct LoadSceneParameters/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::SceneManagement::LoadSceneMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::SceneManagement::LocalPhysicsMode) == 0x14);
    public:
  ...
  static_assert(sizeof(LoadSceneParameters) == 0x18);
}
