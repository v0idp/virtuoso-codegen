...
namespace UnityEngine::SceneManagement {
  ...
  #pragma pack(pop)
  static check_size<sizeof(UnloadSceneOptions), 16 + sizeof(int)> __UnityEngine_SceneManagement_UnloadSceneOptionsSizeCheck;
  static_assert(sizeof(UnloadSceneOptions) == 0x14);
}
