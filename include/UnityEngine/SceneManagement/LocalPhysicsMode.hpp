...
namespace UnityEngine::SceneManagement {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LocalPhysicsMode), 16 + sizeof(int)> __UnityEngine_SceneManagement_LocalPhysicsModeSizeCheck;
  static_assert(sizeof(LocalPhysicsMode) == 0x14);
}
