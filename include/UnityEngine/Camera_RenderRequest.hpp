...
namespace UnityEngine {
  ...
  struct Camera::RenderRequest/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Camera::RenderRequestMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Camera::RenderRequestOutputSpace) == 0x14);
    public:
  ...
  static_assert(sizeof(Camera::RenderRequest) == 0x24);
}
