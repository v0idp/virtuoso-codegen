...
namespace UnityEngine {
  ...
  struct Camera::RenderRequest/*, public ::System::ValueType*/ {
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::Camera::RenderRequestMode& dyn_m_CameraRenderMode();
    // Get instance field reference: private readonly UnityEngine.RenderTexture m_ResultRT
    [[deprecated("Use field access instead!")]] ::UnityEngine::RenderTexture*& dyn_m_ResultRT();
    // Get instance field reference: private readonly UnityEngine.Camera/UnityEngine.RenderRequestOutputSpace m_OutputSpace
    [[deprecated("Use field access instead!")]] ::UnityEngine::Camera::RenderRequestOutputSpace& dyn_m_OutputSpace();
