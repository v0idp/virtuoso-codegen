...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TouchScreenKeyboardType), 16 + sizeof(int)> __UnityEngine_TouchScreenKeyboardTypeSizeCheck;
  static_assert(sizeof(TouchScreenKeyboardType) == 0x14);
}
