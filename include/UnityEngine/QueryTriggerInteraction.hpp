...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(QueryTriggerInteraction), 16 + sizeof(int)> __UnityEngine_QueryTriggerInteractionSizeCheck;
  static_assert(sizeof(QueryTriggerInteraction) == 0x14);
}
