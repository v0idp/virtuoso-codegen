...
namespace UnityEngine::Video {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 5C2254
  ...
  #pragma pack(pop)
  static check_size<sizeof(VideoTimeReference), 16 + sizeof(int)> __UnityEngine_Video_VideoTimeReferenceSizeCheck;
  static_assert(sizeof(VideoTimeReference) == 0x14);
}
