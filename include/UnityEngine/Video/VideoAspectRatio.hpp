...
namespace UnityEngine::Video {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 5C2234
  ...
  #pragma pack(pop)
  static check_size<sizeof(VideoAspectRatio), 16 + sizeof(int)> __UnityEngine_Video_VideoAspectRatioSizeCheck;
  static_assert(sizeof(VideoAspectRatio) == 0x14);
}
