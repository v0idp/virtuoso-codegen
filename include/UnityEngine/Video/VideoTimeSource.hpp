...
namespace UnityEngine::Video {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 5C2244
  ...
  #pragma pack(pop)
  static check_size<sizeof(VideoTimeSource), 16 + sizeof(int)> __UnityEngine_Video_VideoTimeSourceSizeCheck;
  static_assert(sizeof(VideoTimeSource) == 0x14);
}
