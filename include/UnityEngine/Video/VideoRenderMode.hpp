...
namespace UnityEngine::Video {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 5C2214
  ...
  #pragma pack(pop)
  static check_size<sizeof(VideoRenderMode), 16 + sizeof(int)> __UnityEngine_Video_VideoRenderModeSizeCheck;
  static_assert(sizeof(VideoRenderMode) == 0x14);
}
