...
namespace UnityEngine::Video {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 5C2274
  ...
  #pragma pack(pop)
  static check_size<sizeof(VideoAudioOutputMode), 16 + sizeof(int)> __UnityEngine_Video_VideoAudioOutputModeSizeCheck;
  static_assert(sizeof(VideoAudioOutputMode) == 0x14);
}
