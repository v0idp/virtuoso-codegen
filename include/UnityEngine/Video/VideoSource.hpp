...
namespace UnityEngine::Video {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 5C2264
  ...
  #pragma pack(pop)
  static check_size<sizeof(VideoSource), 16 + sizeof(int)> __UnityEngine_Video_VideoSourceSizeCheck;
  static_assert(sizeof(VideoSource) == 0x14);
}
