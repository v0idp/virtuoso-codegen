...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Image::OriginHorizontal), 16 + sizeof(int)> __UnityEngine_UI_Image_OriginHorizontalSizeCheck;
  static_assert(sizeof(Image::OriginHorizontal) == 0x14);
}
