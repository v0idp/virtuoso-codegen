...
namespace UnityEngine::UI {
  ...
  // [RequireComponent] Offset: 6A9C3C
  // [AddComponentMenu] Offset: 6A9C3C
  class RawImage : public ::UnityEngine::UI::MaskableGraphic {
    public:
    public:
    // [FormerlySerializedAsAttribute] Offset: 0x6ABAAC
  ...
  #pragma pack(pop)
  static check_size<sizeof(RawImage), 216 + sizeof(::UnityEngine::Rect)> __UnityEngine_UI_RawImageSizeCheck;
  static_assert(sizeof(RawImage) == 0xE8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
