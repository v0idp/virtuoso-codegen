...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Image::OriginVertical), 16 + sizeof(int)> __UnityEngine_UI_Image_OriginVerticalSizeCheck;
  static_assert(sizeof(Image::OriginVertical) == 0x14);
}
