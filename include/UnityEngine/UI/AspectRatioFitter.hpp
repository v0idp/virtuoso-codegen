...
namespace UnityEngine::UI {
  ...
  class AspectRatioFitter : public ::UnityEngine::EventSystems::UIBehaviour/*, public ::UnityEngine::UI::ILayoutSelfController*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(AspectRatioFitter::AspectMode), 16 + sizeof(int)> __UnityEngine_UI_AspectRatioFitter_AspectModeSizeCheck;
    static_assert(sizeof(AspectRatioFitter::AspectMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::UI::AspectRatioFitter::AspectMode) == 0x14);
