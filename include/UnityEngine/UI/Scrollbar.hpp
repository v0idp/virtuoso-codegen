...
namespace UnityEngine::UI {
  ...
  // [RequireComponent] Offset: 595C70
  // [AddComponentMenu] Offset: 595C70
  class Scrollbar : public ::UnityEngine::UI::Selectable/*, public ::UnityEngine::UI::ICanvasElement, public ::UnityEngine::EventSystems::IBeginDragHandler, public ::UnityEngine::EventSystems::IDragHandler, public ::UnityEngine::EventSystems::IInitializePotentialDragHandler*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(Scrollbar::Direction), 16 + sizeof(int)> __UnityEngine_UI_Scrollbar_DirectionSizeCheck;
    static_assert(sizeof(Scrollbar::Direction) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::UI::Scrollbar::Direction) == 0x14);
    // [RangeAttribute] Offset: 0x597A94
    ...
    // [RangeAttribute] Offset: 0x597AD4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0x597B14
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [SpaceAttribute] Offset: 0x597B54
