...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: 5954F8
  // [RequireComponent] Offset: 5954F8
  class Image : public ::UnityEngine::UI::MaskableGraphic/*, public ::UnityEngine::ISerializationCallbackReceiver, public ::UnityEngine::UI::ILayoutElement, public ::UnityEngine::ICanvasRaycastFilter*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(Image::Type), 16 + sizeof(int)> __UnityEngine_UI_Image_TypeSizeCheck;
    static_assert(sizeof(Image::Type) == 0x14);
    // Size: 0x14
    #pragma pack(push, 1)
    ...
    #pragma pack(pop)
    static check_size<sizeof(Image::FillMethod), 16 + sizeof(int)> __UnityEngine_UI_Image_FillMethodSizeCheck;
    static_assert(sizeof(Image::FillMethod) == 0x14);
    ...
    #endif
    #endif
    // [FormerlySerializedAsAttribute] Offset: 0x596CAC
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::UI::Image::Type) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::UI::Image::FillMethod) == 0x14);
    // [RangeAttribute] Offset: 0x596D38
  ...
  #pragma pack(pop)
  static check_size<sizeof(Image), 260 + sizeof(float)> __UnityEngine_UI_ImageSizeCheck;
  static_assert(sizeof(Image) == 0x108);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
