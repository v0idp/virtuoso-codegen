...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InputField::EditState), 16 + sizeof(int)> __UnityEngine_UI_InputField_EditStateSizeCheck;
  static_assert(sizeof(InputField::EditState) == 0x14);
}
