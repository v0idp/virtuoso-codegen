...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(HorizontalOrVerticalLayoutGroup), 98 + sizeof(bool)> __UnityEngine_UI_HorizontalOrVerticalLayoutGroupSizeCheck;
  static_assert(sizeof(HorizontalOrVerticalLayoutGroup) == 0x63);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
