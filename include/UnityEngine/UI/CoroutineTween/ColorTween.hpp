...
namespace UnityEngine::UI::CoroutineTween {
  ...
  struct ColorTween/*, public ::System::ValueType, public ::UnityEngine::UI::CoroutineTween::ITweenValue*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(ColorTween::ColorTweenMode), 16 + sizeof(int)> __UnityEngine_UI_CoroutineTween_ColorTween_ColorTweenModeSizeCheck;
    static_assert(sizeof(ColorTween::ColorTweenMode) == 0x14);
    public:
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::UI::CoroutineTween::ColorTween::ColorTweenMode) == 0x14);
