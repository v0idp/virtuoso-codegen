...
namespace UnityEngine::UI {
  ...
  class StencilMaterial::MatEntry : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Rendering::StencilOp) == 0x14);
    // public UnityEngine.Rendering.CompareFunction compareFunction
    // Size: 0x14
    // Offset: 0x2C
    ::UnityEngine::Rendering::CompareFunction compareFunction;
    // Field size check
    static_assert(sizeof(::UnityEngine::Rendering::CompareFunction) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Rendering::ColorWriteMask) == 0x14);
    public:
  ...
  static_assert(sizeof(StencilMaterial::MatEntry) == 0x50);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
