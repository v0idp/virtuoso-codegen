...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: 6A958C
  // [RequireComponent] Offset: 6A958C
  class GraphicRaycaster : public ::UnityEngine::EventSystems::BaseRaycaster {
    ...
    public:
    // [FormerlySerializedAsAttribute] Offset: 0x6AADB8
    ...
    char __padding0[0x3] = {};
    // [FormerlySerializedAsAttribute] Offset: 0x6AAE04
