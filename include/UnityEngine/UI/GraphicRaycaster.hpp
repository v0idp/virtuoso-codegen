...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: 5953D8
  // [RequireComponent] Offset: 5953D8
  class GraphicRaycaster : public ::UnityEngine::EventSystems::BaseRaycaster {
    ...
    #pragma pack(pop)
    static check_size<sizeof(GraphicRaycaster::BlockingObjects), 16 + sizeof(int)> __UnityEngine_UI_GraphicRaycaster_BlockingObjectsSizeCheck;
    static_assert(sizeof(GraphicRaycaster::BlockingObjects) == 0x14);
    ...
    #endif
    #endif
    // [FormerlySerializedAsAttribute] Offset: 0x596C04
    ...
    char __padding0[0x3] = {};
    // [FormerlySerializedAsAttribute] Offset: 0x596C50
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::UI::GraphicRaycaster::BlockingObjects) == 0x14);
