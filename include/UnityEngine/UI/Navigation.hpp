...
namespace UnityEngine::UI {
  ...
  struct Navigation/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::UI::Navigation>*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(Navigation::Mode), 16 + sizeof(int)> __UnityEngine_UI_Navigation_ModeSizeCheck;
    static_assert(sizeof(Navigation::Mode) == 0x14);
    public:
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::UI::Navigation::Mode) == 0x14);
    // [TooltipAttribute] Offset: 0x59786C
