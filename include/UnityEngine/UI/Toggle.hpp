...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: 595EA8
  // [RequireComponent] Offset: 595EA8
  class Toggle : public ::UnityEngine::UI::Selectable/*, public ::UnityEngine::EventSystems::IPointerClickHandler, public ::UnityEngine::EventSystems::ISubmitHandler, public ::UnityEngine::UI::ICanvasElement*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(Toggle::ToggleTransition), 16 + sizeof(int)> __UnityEngine_UI_Toggle_ToggleTransitionSizeCheck;
    static_assert(sizeof(Toggle::ToggleTransition) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::UI::Toggle::ToggleTransition) == 0x14);
    ...
    // [TooltipAttribute] Offset: 0x597FA4
