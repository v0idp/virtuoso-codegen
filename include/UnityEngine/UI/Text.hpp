...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: 595E20
  // [RequireComponent] Offset: 595E20
  class Text : public ::UnityEngine::UI::MaskableGraphic/*, public ::UnityEngine::UI::ILayoutElement*/ {
    ...
    // [TextAreaAttribute] Offset: 0x597F54
  ...
  #pragma pack(pop)
  static check_size<sizeof(Text), 248 + sizeof(::ArrayW<::UnityEngine::UIVertex>)> __UnityEngine_UI_TextSizeCheck;
  static_assert(sizeof(Text) == 0x100);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
