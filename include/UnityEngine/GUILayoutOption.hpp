...
namespace UnityEngine {
  ...
  class GUILayoutOption : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(GUILayoutOption::Type), 16 + sizeof(int)> __UnityEngine_GUILayoutOption_TypeSizeCheck;
    static_assert(sizeof(GUILayoutOption::Type) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::GUILayoutOption::Type) == 0x14);
    // System.Object value
    // Size: 0x8
    // Offset: 0x18
    ::Il2CppObject* value;
