...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(UISystemProfilerApi::SampleType), 16 + sizeof(int)> __UnityEngine_UISystemProfilerApi_SampleTypeSizeCheck;
  static_assert(sizeof(UISystemProfilerApi::SampleType) == 0x14);
}
