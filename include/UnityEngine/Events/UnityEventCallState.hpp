...
namespace UnityEngine::Events {
  ...
  #pragma pack(pop)
  static check_size<sizeof(UnityEventCallState), 16 + sizeof(int)> __UnityEngine_Events_UnityEventCallStateSizeCheck;
  static_assert(sizeof(UnityEventCallState) == 0x14);
}
