...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TerrainData::BoundaryValueType), 16 + sizeof(int)> __UnityEngine_TerrainData_BoundaryValueTypeSizeCheck;
  static_assert(sizeof(TerrainData::BoundaryValueType) == 0x14);
}
