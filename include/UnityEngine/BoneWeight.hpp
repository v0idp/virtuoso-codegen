...
namespace UnityEngine {
  ...
  struct BoneWeight/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::BoneWeight>*/ {
    ...
    // [SerializeField] Offset: 0x664BC4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SerializeField] Offset: 0x664BD4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SerializeField] Offset: 0x664BE4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SerializeField] Offset: 0x664BF4
    ...
    // [SerializeField] Offset: 0x664C04
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [SerializeField] Offset: 0x664C14
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [SerializeField] Offset: 0x664C24
