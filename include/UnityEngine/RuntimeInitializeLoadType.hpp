...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(RuntimeInitializeLoadType), 16 + sizeof(int)> __UnityEngine_RuntimeInitializeLoadTypeSizeCheck;
  static_assert(sizeof(RuntimeInitializeLoadType) == 0x14);
}
