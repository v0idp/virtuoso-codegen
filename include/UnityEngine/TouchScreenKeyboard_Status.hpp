...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TouchScreenKeyboard::Status), 16 + sizeof(int)> __UnityEngine_TouchScreenKeyboard_StatusSizeCheck;
  static_assert(sizeof(TouchScreenKeyboard::Status) == 0x14);
}
