...
namespace UnityEngine::Scripting {
  ...
  // [NativeHeaderAttribute] Offset: 662060
  class GarbageCollector : public ::Il2CppObject {
    ...
    struct Mode/*, public ::System::Enum*/ {
      ...
      // static field const value: static public UnityEngine.Scripting.GarbageCollector/UnityEngine.Scripting.Mode Manual
      ...
      static ::UnityEngine::Scripting::GarbageCollector::Mode _get_Manual();
    ...
    // static public UnityEngine.Scripting.GarbageCollector/UnityEngine.Scripting.Mode get_GCMode()
    // Offset: 0x1127EEC
    static ::UnityEngine::Scripting::GarbageCollector::Mode get_GCMode();
...
// Writing MetadataGetter for method: UnityEngine::Scripting::GarbageCollector::get_GCMode
// Il2CppName: get_GCMode
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Scripting::GarbageCollector::Mode (*)()>(&UnityEngine::Scripting::GarbageCollector::get_GCMode)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Scripting::GarbageCollector*), "get_GCMode", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
