...
namespace UnityEngine::Scripting {
  ...
  // [NativeHeaderAttribute] Offset: 567E74
  class GarbageCollector : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(GarbageCollector::Mode), 16 + sizeof(int)> __UnityEngine_Scripting_GarbageCollector_ModeSizeCheck;
    static_assert(sizeof(GarbageCollector::Mode) == 0x14);
