...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Camera::StereoscopicEye), 16 + sizeof(int)> __UnityEngine_Camera_StereoscopicEyeSizeCheck;
  static_assert(sizeof(Camera::StereoscopicEye) == 0x14);
}
