...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: 660E30
  class ColorUsageAttribute : public ::UnityEngine::PropertyAttribute {
    ...
    char __padding1[0x2] = {};
    // [ObsoleteAttribute] Offset: 0x6652F4
    ...
    // [ObsoleteAttribute] Offset: 0x66532C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x665364
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x66539C
