...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Camera::RenderRequestOutputSpace), 16 + sizeof(int)> __UnityEngine_Camera_RenderRequestOutputSpaceSizeCheck;
  static_assert(sizeof(Camera::RenderRequestOutputSpace) == 0x14);
}
