...
namespace UnityEngine::Bindings {
  ...
  #pragma pack(pop)
  static check_size<sizeof(StaticAccessorType), 16 + sizeof(int)> __UnityEngine_Bindings_StaticAccessorTypeSizeCheck;
  static_assert(sizeof(StaticAccessorType) == 0x14);
}
