...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: 5BA508
  ...
  static_assert(sizeof(NativePropertyAttribute) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
