...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: 6D04F0
  class NativeConditionalAttribute : public ::System::Attribute {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x6D0A74
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x6D0AB0
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [DebuggerBrowsableAttribute] Offset: 0x6D0AEC
