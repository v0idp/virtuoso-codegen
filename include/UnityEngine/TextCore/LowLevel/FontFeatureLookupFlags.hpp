...
namespace UnityEngine::TextCore::LowLevel {
  ...
  #pragma pack(pop)
  static check_size<sizeof(FontFeatureLookupFlags), 16 + sizeof(int)> __UnityEngine_TextCore_LowLevel_FontFeatureLookupFlagsSizeCheck;
  static_assert(sizeof(FontFeatureLookupFlags) == 0x14);
}
