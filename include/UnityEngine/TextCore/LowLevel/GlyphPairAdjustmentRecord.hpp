...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [UsedByNativeCodeAttribute] Offset: 5BC52C
  // [DebuggerDisplayAttribute] Offset: 5BC52C
  struct GlyphPairAdjustmentRecord/*, public ::System::ValueType*/ {
    public:
    public:
    // [NativeNameAttribute] Offset: 0x5BD1F8
    ...
    // [NativeNameAttribute] Offset: 0x5BD244
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::TextCore::LowLevel::FontFeatureLookupFlags) == 0x14);
    public:
  ...
  static_assert(sizeof(GlyphPairAdjustmentRecord) == 0x3C);
}
