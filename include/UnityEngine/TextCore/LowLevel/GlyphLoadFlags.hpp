...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [UsedByNativeCodeAttribute] Offset: 5BC578
  ...
  #pragma pack(pop)
  static check_size<sizeof(GlyphLoadFlags), 16 + sizeof(int)> __UnityEngine_TextCore_LowLevel_GlyphLoadFlagsSizeCheck;
  static_assert(sizeof(GlyphLoadFlags) == 0x14);
}
