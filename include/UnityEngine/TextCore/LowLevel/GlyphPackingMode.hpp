...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [UsedByNativeCodeAttribute] Offset: 5BC5C0
  ...
  #pragma pack(pop)
  static check_size<sizeof(GlyphPackingMode), 16 + sizeof(int)> __UnityEngine_TextCore_LowLevel_GlyphPackingModeSizeCheck;
  static_assert(sizeof(GlyphPackingMode) == 0x14);
}
