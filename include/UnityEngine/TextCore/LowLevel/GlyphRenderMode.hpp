...
namespace UnityEngine::TextCore::LowLevel {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GlyphRenderMode), 16 + sizeof(int)> __UnityEngine_TextCore_LowLevel_GlyphRenderModeSizeCheck;
  static_assert(sizeof(GlyphRenderMode) == 0x14);
}
