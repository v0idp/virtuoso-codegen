...
namespace UnityEngine::TextCore::LowLevel {
  ...
  #pragma pack(pop)
  static check_size<sizeof(FontEngineError), 16 + sizeof(int)> __UnityEngine_TextCore_LowLevel_FontEngineErrorSizeCheck;
  static_assert(sizeof(FontEngineError) == 0x14);
}
