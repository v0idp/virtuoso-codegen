...
namespace UnityEngine::EventSystems {
  ...
  class PointerEventData : public ::UnityEngine::EventSystems::BaseEventData {
    ...
    #pragma pack(pop)
    static check_size<sizeof(PointerEventData::InputButton), 16 + sizeof(int)> __UnityEngine_EventSystems_PointerEventData_InputButtonSizeCheck;
    static_assert(sizeof(PointerEventData::InputButton) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::EventSystems::PointerEventData::InputButton) == 0x14);
    public:
    ...
    ::UnityEngine::GameObject*& dyn_$pointerClick$k__BackingField();
  ...
  #pragma pack(pop)
  static check_size<sizeof(PointerEventData), 308 + sizeof(::UnityEngine::EventSystems::PointerEventData::InputButton)> __UnityEngine_EventSystems_PointerEventDataSizeCheck;
  static_assert(sizeof(PointerEventData) == 0x148);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
