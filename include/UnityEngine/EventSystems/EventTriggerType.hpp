...
namespace UnityEngine::EventSystems {
  ...
  #pragma pack(pop)
  static check_size<sizeof(EventTriggerType), 16 + sizeof(int)> __UnityEngine_EventSystems_EventTriggerTypeSizeCheck;
  static_assert(sizeof(EventTriggerType) == 0x14);
}
