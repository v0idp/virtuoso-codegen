...
namespace UnityEngine::EventSystems {
  ...
  // [ObsoleteAttribute] Offset: 58BC74
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRInputModule::InputMode), 16 + sizeof(int)> __UnityEngine_EventSystems_OVRInputModule_InputModeSizeCheck;
  static_assert(sizeof(OVRInputModule::InputMode) == 0x14);
}
