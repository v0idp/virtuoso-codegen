...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: 6B3BC4
  // [NativeConditionalAttribute] Offset: 6B3BC4
  // [NativeHeaderAttribute] Offset: 6B3BC4
  // [StaticAccessorAttribute] Offset: 6B3BC4
