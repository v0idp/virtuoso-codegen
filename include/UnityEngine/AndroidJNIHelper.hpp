...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: 59FA10
  // [NativeConditionalAttribute] Offset: 59FA10
  // [NativeHeaderAttribute] Offset: 59FA10
  // [StaticAccessorAttribute] Offset: 59FA10
