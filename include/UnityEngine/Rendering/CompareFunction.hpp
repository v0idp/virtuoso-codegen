...
namespace UnityEngine::Rendering {
  ...
  // [NativeHeaderAttribute] Offset: 568BB8
  ...
  #pragma pack(pop)
  static check_size<sizeof(CompareFunction), 16 + sizeof(int)> __UnityEngine_Rendering_CompareFunctionSizeCheck;
  static_assert(sizeof(CompareFunction) == 0x14);
}
