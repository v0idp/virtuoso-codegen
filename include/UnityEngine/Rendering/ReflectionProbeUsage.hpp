...
namespace UnityEngine::Rendering {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ReflectionProbeUsage), 16 + sizeof(int)> __UnityEngine_Rendering_ReflectionProbeUsageSizeCheck;
  static_assert(sizeof(ReflectionProbeUsage) == 0x14);
}
