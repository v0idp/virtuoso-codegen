...
namespace UnityEngine::Rendering {
  ...
  // [NativeHeaderAttribute] Offset: 568C00
  ...
  #pragma pack(pop)
  static check_size<sizeof(StencilOp), 16 + sizeof(int)> __UnityEngine_Rendering_StencilOpSizeCheck;
  static_assert(sizeof(StencilOp) == 0x14);
}
