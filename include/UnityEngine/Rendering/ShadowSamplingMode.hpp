...
namespace UnityEngine::Rendering {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ShadowSamplingMode), 16 + sizeof(int)> __UnityEngine_Rendering_ShadowSamplingModeSizeCheck;
  static_assert(sizeof(ShadowSamplingMode) == 0x14);
}
