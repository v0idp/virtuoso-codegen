...
namespace UnityEngine::Rendering {
  ...
  class RenderPipelineManager : public ::Il2CppObject {
    ...
    // static private System.Void DoRenderLoop_Internal(UnityEngine.Rendering.RenderPipelineAsset pipe, System.IntPtr loopPtr, System.Collections.Generic.List`1<UnityEngine.Camera/UnityEngine.RenderRequest> renderRequests)
    // Offset: 0xBCCECC
    static void DoRenderLoop_Internal(::UnityEngine::Rendering::RenderPipelineAsset* pipe, ::System::IntPtr loopPtr, ::System::Collections::Generic::List_1<::UnityEngine::Camera::RenderRequest>* renderRequests);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Rendering::RenderPipelineAsset*, ::System::IntPtr, ::System::Collections::Generic::List_1<::UnityEngine::Camera::RenderRequest>*)>(&UnityEngine::Rendering::RenderPipelineManager::DoRenderLoop_Internal)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Rendering::RenderPipelineManager*), "DoRenderLoop_Internal", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{pipe, loopPtr, renderRequests});
  }
};
