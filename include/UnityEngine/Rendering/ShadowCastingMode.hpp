...
namespace UnityEngine::Rendering {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ShadowCastingMode), 16 + sizeof(int)> __UnityEngine_Rendering_ShadowCastingModeSizeCheck;
  static_assert(sizeof(ShadowCastingMode) == 0x14);
}
