...
namespace UnityEngine::Rendering {
  ...
  // [NativeHeaderAttribute] Offset: 568EA4
  // [UsedByNativeCodeAttribute] Offset: 568EA4
  struct BatchCullingContext/*, public ::System::ValueType*/ {
    ...
    ::Unity::Collections::NativeArray_1<int>& dyn_visibleIndicesY();
    ...
    ::UnityEngine::Matrix4x4& dyn_cullingMatrix();
