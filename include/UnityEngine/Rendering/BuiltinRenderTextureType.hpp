...
namespace UnityEngine::Rendering {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BuiltinRenderTextureType), 16 + sizeof(int)> __UnityEngine_Rendering_BuiltinRenderTextureTypeSizeCheck;
  static_assert(sizeof(BuiltinRenderTextureType) == 0x14);
}
