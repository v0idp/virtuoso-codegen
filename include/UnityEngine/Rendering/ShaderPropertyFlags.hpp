...
namespace UnityEngine::Rendering {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ShaderPropertyFlags), 16 + sizeof(int)> __UnityEngine_Rendering_ShaderPropertyFlagsSizeCheck;
  static_assert(sizeof(ShaderPropertyFlags) == 0x14);
}
