...
namespace UnityEngine::Rendering {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CommandBufferExecutionFlags), 16 + sizeof(int)> __UnityEngine_Rendering_CommandBufferExecutionFlagsSizeCheck;
  static_assert(sizeof(CommandBufferExecutionFlags) == 0x14);
}
