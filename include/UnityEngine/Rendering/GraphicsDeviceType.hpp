...
namespace UnityEngine::Rendering {
  ...
  // [UsedByNativeCodeAttribute] Offset: 568C38
  ...
  #pragma pack(pop)
  static check_size<sizeof(GraphicsDeviceType), 16 + sizeof(int)> __UnityEngine_Rendering_GraphicsDeviceTypeSizeCheck;
  static_assert(sizeof(GraphicsDeviceType) == 0x14);
}
