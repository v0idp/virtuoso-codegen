...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: 5B2D18
  // [NativeHeaderAttribute] Offset: 5B2D18
  // [RequiredByNativeCodeAttribute] Offset: 5B2D18
  struct InputFeatureUsage/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::XR::InputFeatureUsage>*/ {
    ...
    // [NativeNameAttribute] Offset: 0x5B36E0
    // UnityEngine.XR.InputFeatureType m_InternalType
    // Size: 0x14
    // Offset: 0x8
    ::UnityEngine::XR::InputFeatureType m_InternalType;
    // Field size check
    static_assert(sizeof(::UnityEngine::XR::InputFeatureType) == 0x14);
    public:
  ...
  static_assert(sizeof(InputFeatureUsage) == 0x1C);
}
