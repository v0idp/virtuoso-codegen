...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 5B3490
  // [FlagsAttribute] Offset: FFFFFFFF
  // [UsedByNativeCodeAttribute] Offset: 5B3490
  ...
  #pragma pack(pop)
  static check_size<sizeof(MeshVertexAttributes), 16 + sizeof(int)> __UnityEngine_XR_MeshVertexAttributesSizeCheck;
  static_assert(sizeof(MeshVertexAttributes) == 0x14);
}
