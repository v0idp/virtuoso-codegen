...
namespace UnityEngine::XR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InputTracking::TrackingStateEventType), 16 + sizeof(int)> __UnityEngine_XR_InputTracking_TrackingStateEventTypeSizeCheck;
  static_assert(sizeof(InputTracking::TrackingStateEventType) == 0x14);
}
