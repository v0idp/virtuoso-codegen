...
namespace UnityEngine::XR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InputDeviceCharacteristics), 16 + sizeof(uint)> __UnityEngine_XR_InputDeviceCharacteristicsSizeCheck;
  static_assert(sizeof(InputDeviceCharacteristics) == 0x14);
}
