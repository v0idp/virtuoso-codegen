...
namespace UnityEngine::XR {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 5B2F94
  // [StaticAccessorAttribute] Offset: 5B2F94
  // [NativeHeaderAttribute] Offset: 5B2F94
  // [NativeHeaderAttribute] Offset: 5B2F94
  // [NativeConditionalAttribute] Offset: 5B2F94
  // [NativeHeaderAttribute] Offset: 5B2F94
