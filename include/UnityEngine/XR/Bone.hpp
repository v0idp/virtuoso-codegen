...
namespace UnityEngine::XR {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 6C90C4
  // [StaticAccessorAttribute] Offset: 6C90C4
  // [NativeHeaderAttribute] Offset: 6C90C4
  // [NativeHeaderAttribute] Offset: 6C90C4
  // [NativeConditionalAttribute] Offset: 6C90C4
  // [NativeHeaderAttribute] Offset: 6C90C4
