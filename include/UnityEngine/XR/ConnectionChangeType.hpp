...
namespace UnityEngine::XR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ConnectionChangeType), 16 + sizeof(uint)> __UnityEngine_XR_ConnectionChangeTypeSizeCheck;
  static_assert(sizeof(ConnectionChangeType) == 0x14);
}
