...
namespace UnityEngine::XR {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AvailableTrackingData), 16 + sizeof(int)> __UnityEngine_XR_AvailableTrackingDataSizeCheck;
  static_assert(sizeof(AvailableTrackingData) == 0x14);
}
