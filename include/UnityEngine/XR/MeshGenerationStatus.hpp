...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 5B33F8
  // [RequiredByNativeCodeAttribute] Offset: 5B33F8
  ...
  #pragma pack(pop)
  static check_size<sizeof(MeshGenerationStatus), 16 + sizeof(int)> __UnityEngine_XR_MeshGenerationStatusSizeCheck;
  static_assert(sizeof(MeshGenerationStatus) == 0x14);
}
