...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OperatingSystemFamily), 16 + sizeof(int)> __UnityEngine_OperatingSystemFamilySizeCheck;
  static_assert(sizeof(OperatingSystemFamily) == 0x14);
}
