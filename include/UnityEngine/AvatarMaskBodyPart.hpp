...
namespace UnityEngine {
  ...
  // [MovedFromAttribute] Offset: 5A619C
  ...
  #pragma pack(pop)
  static check_size<sizeof(AvatarMaskBodyPart), 16 + sizeof(int)> __UnityEngine_AvatarMaskBodyPartSizeCheck;
  static_assert(sizeof(AvatarMaskBodyPart) == 0x14);
}
