...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 565064
  class ReflectionProbe : public ::UnityEngine::Behaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(ReflectionProbe::ReflectionProbeEvent), 16 + sizeof(int)> __UnityEngine_ReflectionProbe_ReflectionProbeEventSizeCheck;
    static_assert(sizeof(ReflectionProbe::ReflectionProbeEvent) == 0x14);
    // [DebuggerBrowsableAttribute] Offset: 0x56A1D0
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x56A20C
