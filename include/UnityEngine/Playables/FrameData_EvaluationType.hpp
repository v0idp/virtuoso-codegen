...
namespace UnityEngine::Playables {
  ...
  #pragma pack(pop)
  static check_size<sizeof(FrameData::EvaluationType), 16 + sizeof(int)> __UnityEngine_Playables_FrameData_EvaluationTypeSizeCheck;
  static_assert(sizeof(FrameData::EvaluationType) == 0x14);
}
