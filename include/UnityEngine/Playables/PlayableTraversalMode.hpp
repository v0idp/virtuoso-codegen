...
namespace UnityEngine::Playables {
  ...
  #pragma pack(pop)
  static check_size<sizeof(PlayableTraversalMode), 16 + sizeof(int)> __UnityEngine_Playables_PlayableTraversalModeSizeCheck;
  static_assert(sizeof(PlayableTraversalMode) == 0x14);
}
