...
// Writing MetadataGetter for method: UnityEngine::Playables::PlayableBinding::get_outputTargetType
// Il2CppName: get_outputTargetType
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Type* (UnityEngine::Playables::PlayableBinding::*)()>(&UnityEngine::Playables::PlayableBinding::get_outputTargetType)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Playables::PlayableBinding), "get_outputTargetType", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
