...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ParticleSystemRenderMode), 16 + sizeof(int)> __UnityEngine_ParticleSystemRenderModeSizeCheck;
  static_assert(sizeof(ParticleSystemRenderMode) == 0x14);
}
