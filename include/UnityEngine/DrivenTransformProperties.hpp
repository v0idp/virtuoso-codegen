...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(DrivenTransformProperties), 16 + sizeof(int)> __UnityEngine_DrivenTransformPropertiesSizeCheck;
  static_assert(sizeof(DrivenTransformProperties) == 0x14);
}
