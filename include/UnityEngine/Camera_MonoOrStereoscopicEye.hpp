...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(Camera::MonoOrStereoscopicEye), 16 + sizeof(int)> __UnityEngine_Camera_MonoOrStereoscopicEyeSizeCheck;
  static_assert(sizeof(Camera::MonoOrStereoscopicEye) == 0x14);
}
