...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ParticleSystemStopBehavior), 16 + sizeof(int)> __UnityEngine_ParticleSystemStopBehaviorSizeCheck;
  static_assert(sizeof(ParticleSystemStopBehavior) == 0x14);
}
