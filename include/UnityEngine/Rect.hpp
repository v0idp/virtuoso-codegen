...
namespace UnityEngine {
  ...
  // [NativeClassAttribute] Offset: 5652B8
  // [RequiredByNativeCodeAttribute] Offset: 5652B8
  // [NativeHeaderAttribute] Offset: 5652B8
  struct Rect/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::Rect>, public ::System::IFormattable*/ {
    public:
    public:
    // [NativeNameAttribute] Offset: 0x56A2A0
    ...
    // [NativeNameAttribute] Offset: 0x56A2D8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0x56A310
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0x56A348
    ...
    // static public UnityEngine.Vector2 NormalizedToPoint(UnityEngine.Rect rectangle, UnityEngine.Vector2 normalizedRectCoordinates)
    // Offset: 0x9D4D14
    static ::UnityEngine::Vector2 NormalizedToPoint(::UnityEngine::Rect rectangle, ::UnityEngine::Vector2 normalizedRectCoordinates);
    // static public UnityEngine.Vector2 PointToNormalized(UnityEngine.Rect rectangle, UnityEngine.Vector2 point)
    // Offset: 0x9D4D70
...
// Writing MetadataGetter for method: UnityEngine::Rect::NormalizedToPoint
// Il2CppName: NormalizedToPoint
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector2 (*)(::UnityEngine::Rect, ::UnityEngine::Vector2)>(&UnityEngine::Rect::NormalizedToPoint)> {
  static const MethodInfo* get() {
    static auto* rectangle = &::il2cpp_utils::GetClassFromName("UnityEngine", "Rect")->byval_arg;
    static auto* normalizedRectCoordinates = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Rect), "NormalizedToPoint", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{rectangle, normalizedRectCoordinates});
  }
};
// Writing MetadataGetter for method: UnityEngine::Rect::PointToNormalized
// Il2CppName: PointToNormalized
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector2 (*)(::UnityEngine::Rect, ::UnityEngine::Vector2)>(&UnityEngine::Rect::PointToNormalized)> {
  static const MethodInfo* get() {
    static auto* rectangle = &::il2cpp_utils::GetClassFromName("UnityEngine", "Rect")->byval_arg;
    static auto* point = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Rect), "PointToNormalized", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{rectangle, point});
  }
};
