...
namespace UnityEngine::Analytics {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 5C8734
  ...
  #pragma pack(pop)
  static check_size<sizeof(AnalyticsSessionState), 16 + sizeof(int)> __UnityEngine_Analytics_AnalyticsSessionStateSizeCheck;
  static_assert(sizeof(AnalyticsSessionState) == 0x14);
}
