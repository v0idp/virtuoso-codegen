...
namespace UnityEngine::Networking {
  ...
  #pragma pack(pop)
  static check_size<sizeof(UnityWebRequest::UnityWebRequestMethod), 16 + sizeof(int)> __UnityEngine_Networking_UnityWebRequest_UnityWebRequestMethodSizeCheck;
  static_assert(sizeof(UnityWebRequest::UnityWebRequestMethod) == 0x14);
}
