...
namespace UnityEngine::Networking {
  ...
  #pragma pack(pop)
  static check_size<sizeof(UnityWebRequest::UnityWebRequestError), 16 + sizeof(int)> __UnityEngine_Networking_UnityWebRequest_UnityWebRequestErrorSizeCheck;
  static_assert(sizeof(UnityWebRequest::UnityWebRequestError) == 0x14);
}
