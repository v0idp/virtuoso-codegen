...
namespace UnityEngine {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 567478
  // [AttributeUsageAttribute] Offset: 567478
  class RuntimeInitializeOnLoadMethodAttribute : public ::UnityEngine::Scripting::PreserveAttribute {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::RuntimeInitializeLoadType) == 0x14);
    public:
  ...
  static_assert(sizeof(RuntimeInitializeOnLoadMethodAttribute) == 0x24);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
