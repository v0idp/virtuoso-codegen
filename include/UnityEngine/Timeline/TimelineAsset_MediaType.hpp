...
namespace UnityEngine::Timeline {
  ...
  // [ObsoleteAttribute] Offset: 599A90
  ...
  #pragma pack(pop)
  static check_size<sizeof(TimelineAsset::MediaType), 16 + sizeof(int)> __UnityEngine_Timeline_TimelineAsset_MediaTypeSizeCheck;
  static_assert(sizeof(TimelineAsset::MediaType) == 0x14);
}
