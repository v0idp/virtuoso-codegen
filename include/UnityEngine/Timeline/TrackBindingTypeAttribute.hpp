...
namespace UnityEngine::Timeline {
  ...
  // [AttributeUsageAttribute] Offset: 59A054
  class TrackBindingTypeAttribute : public ::System::Attribute {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Timeline::TrackBindingFlags) == 0x14);
    public:
  ...
  static_assert(sizeof(TrackBindingTypeAttribute) == 0x2C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
