...
namespace UnityEngine::Timeline {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TimelineClip::Versions), 16 + sizeof(int)> __UnityEngine_Timeline_TimelineClip_VersionsSizeCheck;
  static_assert(sizeof(TimelineClip::Versions) == 0x14);
}
