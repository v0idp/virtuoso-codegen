...
namespace UnityEngine::Timeline {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TimelineAsset::Versions), 16 + sizeof(int)> __UnityEngine_Timeline_TimelineAsset_VersionsSizeCheck;
  static_assert(sizeof(TimelineAsset::Versions) == 0x14);
}
