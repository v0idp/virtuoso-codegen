...
namespace UnityEngine::Timeline {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AnimationPlayableAsset::Versions), 16 + sizeof(int)> __UnityEngine_Timeline_AnimationPlayableAsset_VersionsSizeCheck;
  static_assert(sizeof(AnimationPlayableAsset::Versions) == 0x14);
}
