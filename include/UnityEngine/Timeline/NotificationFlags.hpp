...
namespace UnityEngine::Timeline {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NotificationFlags), 16 + sizeof(int16_t)> __UnityEngine_Timeline_NotificationFlagsSizeCheck;
  static_assert(sizeof(NotificationFlags) == 0x12);
}
