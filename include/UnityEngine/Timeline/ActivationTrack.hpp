...
namespace UnityEngine::Timeline {
  ...
  // [TrackClipTypeAttribute] Offset: 5998E4
  // [TrackBindingTypeAttribute] Offset: 5998E4
  ...
  class ActivationTrack : public ::UnityEngine::Timeline::TrackAsset {
    ...
    #pragma pack(pop)
    static check_size<sizeof(ActivationTrack::PostPlaybackState), 16 + sizeof(int)> __UnityEngine_Timeline_ActivationTrack_PostPlaybackStateSizeCheck;
    static_assert(sizeof(ActivationTrack::PostPlaybackState) == 0x14);
