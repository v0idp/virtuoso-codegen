...
namespace UnityEngine::Timeline {
  ...
  class ActivationControlPlayable : public ::UnityEngine::Playables::PlayableBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(ActivationControlPlayable::PostPlaybackState), 16 + sizeof(int)> __UnityEngine_Timeline_ActivationControlPlayable_PostPlaybackStateSizeCheck;
    static_assert(sizeof(ActivationControlPlayable::PostPlaybackState) == 0x14);
    // Size: 0x14
    #pragma pack(push, 1)
    ...
    #pragma pack(pop)
    static check_size<sizeof(ActivationControlPlayable::InitialState), 16 + sizeof(int)> __UnityEngine_Timeline_ActivationControlPlayable_InitialStateSizeCheck;
    static_assert(sizeof(ActivationControlPlayable::InitialState) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Timeline::ActivationControlPlayable::InitialState) == 0x14);
    public:
  ...
  static_assert(sizeof(ActivationControlPlayable) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
