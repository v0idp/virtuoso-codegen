...
namespace UnityEngine::Timeline {
  ...
  class TimelineAsset : public ::UnityEngine::Playables::PlayableAsset/*, public ::UnityEngine::Timeline::ITimelineClipAsset, public ::UnityEngine::Timeline::IPropertyPreview, public ::UnityEngine::ISerializationCallbackReceiver*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(TimelineAsset::DurationMode), 16 + sizeof(int)> __UnityEngine_Timeline_TimelineAsset_DurationModeSizeCheck;
    static_assert(sizeof(TimelineAsset::DurationMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Timeline::TimelineAsset::DurationMode) == 0x14);
