...
namespace UnityEngine::Timeline {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TrackAsset::Versions), 16 + sizeof(int)> __UnityEngine_Timeline_TrackAsset_VersionsSizeCheck;
  static_assert(sizeof(TrackAsset::Versions) == 0x14);
}
