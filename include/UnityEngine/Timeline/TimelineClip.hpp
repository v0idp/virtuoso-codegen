...
namespace UnityEngine::Timeline {
  ...
  class TimelineClip : public ::Il2CppObject/*, public ::UnityEngine::ISerializationCallbackReceiver, public ::UnityEngine::Timeline::ICurvesOwner*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(TimelineClip::ClipExtrapolation), 16 + sizeof(int)> __UnityEngine_Timeline_TimelineClip_ClipExtrapolationSizeCheck;
    static_assert(sizeof(TimelineClip::ClipExtrapolation) == 0x14);
    // Size: 0x14
    #pragma pack(push, 1)
    ...
    #pragma pack(pop)
    static check_size<sizeof(TimelineClip::BlendCurveMode), 16 + sizeof(int)> __UnityEngine_Timeline_TimelineClip_BlendCurveModeSizeCheck;
    static_assert(sizeof(TimelineClip::BlendCurveMode) == 0x14);
    ...
    // [FormerlySerializedAsAttribute] Offset: 0x59A7A0
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Timeline::TimelineClip::BlendCurveMode) == 0x14);
