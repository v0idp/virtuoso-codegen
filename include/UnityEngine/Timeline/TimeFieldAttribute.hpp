...
namespace UnityEngine::Timeline {
  ...
  class TimeFieldAttribute : public ::UnityEngine::PropertyAttribute {
    ...
    #pragma pack(pop)
    static check_size<sizeof(TimeFieldAttribute::UseEditMode), 16 + sizeof(int)> __UnityEngine_Timeline_TimeFieldAttribute_UseEditModeSizeCheck;
    static_assert(sizeof(TimeFieldAttribute::UseEditMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Timeline::TimeFieldAttribute::UseEditMode) == 0x14);
    public:
  ...
  static_assert(sizeof(TimeFieldAttribute) == 0x24);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
