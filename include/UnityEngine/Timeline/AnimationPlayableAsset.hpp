...
namespace UnityEngine::Timeline {
  ...
  // [NotKeyableAttribute] Offset: 599988
  class AnimationPlayableAsset : public ::UnityEngine::Playables::PlayableAsset/*, public ::UnityEngine::Timeline::ITimelineClipAsset, public ::UnityEngine::Timeline::IPropertyPreview, public ::UnityEngine::ISerializationCallbackReceiver*/ {
    ...
    struct LoopMode/*, public ::System::Enum*/ {
      ...
      // [TooltipAttribute] Offset: 0x59A2C8
      ...
      // [TooltipAttribute] Offset: 0x59A300
      ...
      // [TooltipAttribute] Offset: 0x59A338
    ...
    #pragma pack(pop)
    static check_size<sizeof(AnimationPlayableAsset::LoopMode), 16 + sizeof(int)> __UnityEngine_Timeline_AnimationPlayableAsset_LoopModeSizeCheck;
    static_assert(sizeof(AnimationPlayableAsset::LoopMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Timeline::AppliedOffsetMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [ObsoleteAttribute] Offset: 0x59A268
