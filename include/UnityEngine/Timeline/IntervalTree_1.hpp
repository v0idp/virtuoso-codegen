...
namespace UnityEngine::Timeline {
  ...
  class IntervalTree_1 : public ::Il2CppObject {
    ...
    struct Entry : public ::il2cpp_utils::il2cpp_type_check::NestedType/*, public ::System::ValueType*/ {
      ...
      [[deprecated]] int64_t& dyn_intervalStart() {
      ...
      [[deprecated]] int64_t& dyn_intervalEnd() {
    ...
    [[deprecated]] ::System::Collections::Generic::List_1<typename ::UnityEngine::Timeline::IntervalTree_1<T>::Entry>*& dyn_m_Entries() {
    ...
    [[deprecated]] ::System::Collections::Generic::List_1<::UnityEngine::Timeline::IntervalTreeNode>*& dyn_m_Nodes() {
