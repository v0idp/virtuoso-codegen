...
namespace UnityEngine {
  ...
  #pragma pack(pop)
  static check_size<sizeof(RenderTextureReadWrite), 16 + sizeof(int)> __UnityEngine_RenderTextureReadWriteSizeCheck;
  static_assert(sizeof(RenderTextureReadWrite) == 0x14);
}
