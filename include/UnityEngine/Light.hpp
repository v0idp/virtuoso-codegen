...
namespace UnityEngine {
  ...
  // [RequireComponent] Offset: 65FEC8
  // [NativeHeaderAttribute] Offset: 65FEC8
  // [RequireComponent] Offset: 65FEC8
  // [NativeHeaderAttribute] Offset: 65FEC8
  class Light : public ::UnityEngine::Behaviour {
    ...
    // public System.Void set_shadowStrength(System.Single value)
    // Offset: 0x112C320
...
// Writing MetadataGetter for method: UnityEngine::Light::set_shadowStrength
// Il2CppName: set_shadowStrength
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Light::*)(float)>(&UnityEngine::Light::set_shadowStrength)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Light*), "set_shadowStrength", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
