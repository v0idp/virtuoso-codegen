...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ovrAvatarBodyPartType), 16 + sizeof(int)> __GlobalNamespace_ovrAvatarBodyPartTypeSizeCheck;
  static_assert(sizeof(ovrAvatarBodyPartType) == 0x14);
}
