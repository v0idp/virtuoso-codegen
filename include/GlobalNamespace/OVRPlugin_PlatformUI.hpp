...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::PlatformUI), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_PlatformUISizeCheck;
  static_assert(sizeof(OVRPlugin::PlatformUI) == 0x14);
}
