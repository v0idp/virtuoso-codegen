...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::SystemHeadset), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_SystemHeadsetSizeCheck;
  static_assert(sizeof(OVRPlugin::SystemHeadset) == 0x14);
}
