...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_CompositionMethod), 16 + sizeof(int)> __GlobalNamespace_OVRManager_CompositionMethodSizeCheck;
  static_assert(sizeof(OVRManager_CompositionMethod) == 0x14);
}
