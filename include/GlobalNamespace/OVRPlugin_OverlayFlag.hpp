...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::OverlayFlag), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_OverlayFlagSizeCheck;
  static_assert(sizeof(OVRPlugin::OverlayFlag) == 0x14);
}
