...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::CameraDevice), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_CameraDeviceSizeCheck;
  static_assert(sizeof(OVRPlugin::CameraDevice) == 0x14);
}
