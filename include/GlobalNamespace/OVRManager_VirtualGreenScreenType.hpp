...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_VirtualGreenScreenType), 16 + sizeof(int)> __GlobalNamespace_OVRManager_VirtualGreenScreenTypeSizeCheck;
  static_assert(sizeof(OVRManager_VirtualGreenScreenType) == 0x14);
}
