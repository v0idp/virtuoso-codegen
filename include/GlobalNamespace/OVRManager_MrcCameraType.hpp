...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_MrcCameraType), 16 + sizeof(int)> __GlobalNamespace_OVRManager_MrcCameraTypeSizeCheck;
  static_assert(sizeof(OVRManager_MrcCameraType) == 0x14);
}
