...
namespace GlobalNamespace {
  ...
  class OVRHeadsetEmulator : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRHeadsetEmulator::OpMode), 16 + sizeof(int)> __GlobalNamespace_OVRHeadsetEmulator_OpModeSizeCheck;
    static_assert(sizeof(OVRHeadsetEmulator::OpMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRHeadsetEmulator::OpMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::CursorLockMode) == 0x14);
    public:
  ...
  static_assert(sizeof(OVRHeadsetEmulator) == 0x6C);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
