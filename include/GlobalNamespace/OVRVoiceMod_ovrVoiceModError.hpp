...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRVoiceMod::ovrVoiceModError), 16 + sizeof(int)> __GlobalNamespace_OVRVoiceMod_ovrVoiceModErrorSizeCheck;
  static_assert(sizeof(OVRVoiceMod::ovrVoiceModError) == 0x14);
}
