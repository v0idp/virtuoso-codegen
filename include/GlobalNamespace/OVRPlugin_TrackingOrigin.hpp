...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::TrackingOrigin), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_TrackingOriginSizeCheck;
  static_assert(sizeof(OVRPlugin::TrackingOrigin) == 0x14);
}
