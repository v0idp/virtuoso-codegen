...
namespace GlobalNamespace {
  ...
  // [RequireComponent] Offset: 6683D8
  class OVRMicInput : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRMicInput::micActivation), 16 + sizeof(int)> __GlobalNamespace_OVRMicInput_micActivationSizeCheck;
    static_assert(sizeof(OVRMicInput::micActivation) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRMicInput::micActivation) == 0x14);
    ...
    ::GlobalNamespace::OVRMicInput::micActivation& dyn_micControl();
