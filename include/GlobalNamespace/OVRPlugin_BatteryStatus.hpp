...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::BatteryStatus), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_BatteryStatusSizeCheck;
  static_assert(sizeof(OVRPlugin::BatteryStatus) == 0x14);
}
