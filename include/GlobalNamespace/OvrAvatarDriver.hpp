...
namespace GlobalNamespace {
  ...
  class OvrAvatarDriver : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OvrAvatarDriver::PacketMode), 16 + sizeof(int)> __GlobalNamespace_OvrAvatarDriver_PacketModeSizeCheck;
    static_assert(sizeof(OvrAvatarDriver::PacketMode) == 0x14);
    // Size: 0x19
    #pragma pack(push, 1)
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OvrAvatarDriver::PacketMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::ovrAvatarControllerType) == 0x14);
    public:
  ...
  static_assert(sizeof(OvrAvatarDriver) == 0xC0);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
