...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ovrAvatarDebugContext), 16 + sizeof(uint)> __GlobalNamespace_ovrAvatarDebugContextSizeCheck;
  static_assert(sizeof(ovrAvatarDebugContext) == 0x14);
}
