...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRInput::Handedness), 16 + sizeof(int)> __GlobalNamespace_OVRInput_HandednessSizeCheck;
  static_assert(sizeof(OVRInput::Handedness) == 0x14);
}
