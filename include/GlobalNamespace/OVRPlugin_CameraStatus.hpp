...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::CameraStatus), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_CameraStatusSizeCheck;
  static_assert(sizeof(OVRPlugin::CameraStatus) == 0x14);
}
