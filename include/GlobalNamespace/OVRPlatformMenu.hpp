...
namespace GlobalNamespace {
  ...
  class OVRPlatformMenu : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRPlatformMenu::eHandler), 16 + sizeof(int)> __GlobalNamespace_OVRPlatformMenu_eHandlerSizeCheck;
    static_assert(sizeof(OVRPlatformMenu::eHandler) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRPlatformMenu::eHandler) == 0x14);
