...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_TrackingOrigin), 16 + sizeof(int)> __GlobalNamespace_OVRManager_TrackingOriginSizeCheck;
  static_assert(sizeof(OVRManager_TrackingOrigin) == 0x14);
}
