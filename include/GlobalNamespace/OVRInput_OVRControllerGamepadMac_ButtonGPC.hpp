...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRInput::OVRControllerGamepadMac::ButtonGPC), 16 + sizeof(int)> __GlobalNamespace_OVRInput_OVRControllerGamepadMac_ButtonGPCSizeCheck;
  static_assert(sizeof(OVRInput::OVRControllerGamepadMac::ButtonGPC) == 0x14);
}
