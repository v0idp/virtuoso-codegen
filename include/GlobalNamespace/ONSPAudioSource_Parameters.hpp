...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ONSPAudioSource::Parameters), 16 + sizeof(int)> __GlobalNamespace_ONSPAudioSource_ParametersSizeCheck;
  static_assert(sizeof(ONSPAudioSource::Parameters) == 0x14);
}
