...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::CameraAnchorType), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_CameraAnchorTypeSizeCheck;
  static_assert(sizeof(OVRPlugin::CameraAnchorType) == 0x14);
}
