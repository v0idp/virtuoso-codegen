...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRNetwork::OVRNetworkTcpClient::ConnectionState), 16 + sizeof(int)> __GlobalNamespace_OVRNetwork_OVRNetworkTcpClient_ConnectionStateSizeCheck;
  static_assert(sizeof(OVRNetwork::OVRNetworkTcpClient::ConnectionState) == 0x14);
}
