...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_EyeTextureFormat), 16 + sizeof(int)> __GlobalNamespace_OVRManager_EyeTextureFormatSizeCheck;
  static_assert(sizeof(OVRManager_EyeTextureFormat) == 0x14);
}
