...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_XRDevice), 16 + sizeof(int)> __GlobalNamespace_OVRManager_XRDeviceSizeCheck;
  static_assert(sizeof(OVRManager_XRDevice) == 0x14);
}
