...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::Controller), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_ControllerSizeCheck;
  static_assert(sizeof(OVRPlugin::Controller) == 0x14);
}
