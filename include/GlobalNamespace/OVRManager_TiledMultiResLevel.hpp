...
namespace GlobalNamespace {
  ...
  // [ObsoleteAttribute] Offset: 589DB0
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_TiledMultiResLevel), 16 + sizeof(int)> __GlobalNamespace_OVRManager_TiledMultiResLevelSizeCheck;
  static_assert(sizeof(OVRManager_TiledMultiResLevel) == 0x14);
}
