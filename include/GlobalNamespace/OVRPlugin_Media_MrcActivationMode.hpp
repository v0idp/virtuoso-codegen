...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::Media::MrcActivationMode), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_Media_MrcActivationModeSizeCheck;
  static_assert(sizeof(OVRPlugin::Media::MrcActivationMode) == 0x14);
}
