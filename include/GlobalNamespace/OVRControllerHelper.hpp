...
namespace GlobalNamespace {
  ...
  class OVRControllerHelper : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRControllerHelper::ControllerType), 16 + sizeof(int)> __GlobalNamespace_OVRControllerHelper_ControllerTypeSizeCheck;
    static_assert(sizeof(OVRControllerHelper::ControllerType) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRControllerHelper::ControllerType) == 0x14);
