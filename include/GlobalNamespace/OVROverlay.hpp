...
namespace GlobalNamespace {
  ...
  class OVROverlay : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVROverlay::OverlayShape), 16 + sizeof(int)> __GlobalNamespace_OVROverlay_OverlayShapeSizeCheck;
    static_assert(sizeof(OVROverlay::OverlayShape) == 0x14);
    // Size: 0x14
    #pragma pack(push, 1)
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVROverlay::OverlayType), 16 + sizeof(int)> __GlobalNamespace_OVROverlay_OverlayTypeSizeCheck;
    static_assert(sizeof(OVROverlay::OverlayType) == 0x14);
    // Size: 0x20
    #pragma pack(push, 1)
    ...
    // Padding between fields: layerIdHandle and: layerIdPtr
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRManager_XRDevice) == 0x14);
