...
namespace GlobalNamespace {
  ...
  // [ObsoleteAttribute] Offset: 589ECC
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::TiledMultiResLevel), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_TiledMultiResLevelSizeCheck;
  static_assert(sizeof(OVRPlugin::TiledMultiResLevel) == 0x14);
}
