...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ovrAvatarMaterialLayerBlendMode), 16 + sizeof(int)> __GlobalNamespace_ovrAvatarMaterialLayerBlendModeSizeCheck;
  static_assert(sizeof(ovrAvatarMaterialLayerBlendMode) == 0x14);
}
