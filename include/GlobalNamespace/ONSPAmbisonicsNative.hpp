...
namespace GlobalNamespace {
  ...
  class ONSPAmbisonicsNative : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(ONSPAmbisonicsNative::ovrAmbisonicsNativeStatus), 16 + sizeof(int)> __GlobalNamespace_ONSPAmbisonicsNative_ovrAmbisonicsNativeStatusSizeCheck;
    static_assert(sizeof(ONSPAmbisonicsNative::ovrAmbisonicsNativeStatus) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::ONSPAmbisonicsNative::ovrAmbisonicsNativeStatus) == 0x14);
    public:
  ...
  #pragma pack(pop)
  static check_size<sizeof(ONSPAmbisonicsNative), 32 + sizeof(::GlobalNamespace::ONSPAmbisonicsNative::ovrAmbisonicsNativeStatus)> __GlobalNamespace_ONSPAmbisonicsNativeSizeCheck;
  static_assert(sizeof(ONSPAmbisonicsNative) == 0x34);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
