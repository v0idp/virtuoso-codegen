...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OvrAvatar::HandJoint), 16 + sizeof(int)> __GlobalNamespace_OvrAvatar_HandJointSizeCheck;
  static_assert(sizeof(OvrAvatar::HandJoint) == 0x14);
}
