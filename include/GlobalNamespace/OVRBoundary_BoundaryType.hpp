...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRBoundary::BoundaryType), 16 + sizeof(int)> __GlobalNamespace_OVRBoundary_BoundaryTypeSizeCheck;
  static_assert(sizeof(OVRBoundary::BoundaryType) == 0x14);
}
