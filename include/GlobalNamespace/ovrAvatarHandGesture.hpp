...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ovrAvatarHandGesture), 16 + sizeof(int)> __GlobalNamespace_ovrAvatarHandGestureSizeCheck;
  static_assert(sizeof(ovrAvatarHandGesture) == 0x14);
}
