...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_SystemHeadsetType), 16 + sizeof(int)> __GlobalNamespace_OVRManager_SystemHeadsetTypeSizeCheck;
  static_assert(sizeof(OVRManager_SystemHeadsetType) == 0x14);
}
