...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::ColorSpace), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_ColorSpaceSizeCheck;
  static_assert(sizeof(OVRPlugin::ColorSpace) == 0x14);
}
