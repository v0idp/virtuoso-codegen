...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRVoiceMod::ovrViceModFlag), 16 + sizeof(int)> __GlobalNamespace_OVRVoiceMod_ovrViceModFlagSizeCheck;
  static_assert(sizeof(OVRVoiceMod::ovrViceModFlag) == 0x14);
}
