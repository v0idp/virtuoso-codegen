...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::FixedFoveatedRenderingLevel), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_FixedFoveatedRenderingLevelSizeCheck;
  static_assert(sizeof(OVRPlugin::FixedFoveatedRenderingLevel) == 0x14);
}
