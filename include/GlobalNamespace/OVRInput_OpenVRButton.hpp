...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRInput::OpenVRButton), 16 + sizeof(uint64_t)> __GlobalNamespace_OVRInput_OpenVRButtonSizeCheck;
  static_assert(sizeof(OVRInput::OpenVRButton) == 0x18);
}
