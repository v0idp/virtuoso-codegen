...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ONSPPropagation::ovrAudioScalarType), 16 + sizeof(uint)> __GlobalNamespace_ONSPPropagation_ovrAudioScalarTypeSizeCheck;
  static_assert(sizeof(ONSPPropagation::ovrAudioScalarType) == 0x14);
}
