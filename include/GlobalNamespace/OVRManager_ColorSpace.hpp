...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_ColorSpace), 16 + sizeof(int)> __GlobalNamespace_OVRManager_ColorSpaceSizeCheck;
  static_assert(sizeof(OVRManager_ColorSpace) == 0x14);
}
