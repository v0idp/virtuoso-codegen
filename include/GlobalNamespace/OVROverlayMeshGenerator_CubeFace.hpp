...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVROverlayMeshGenerator::CubeFace), 16 + sizeof(int)> __GlobalNamespace_OVROverlayMeshGenerator_CubeFaceSizeCheck;
  static_assert(sizeof(OVROverlayMeshGenerator::CubeFace) == 0x14);
}
