...
namespace GlobalNamespace {
  ...
  class VoiceModDemo_Logic : public ::UnityEngine::MonoBehaviour {
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<::GlobalNamespace::OVRVoiceModContext*>& dyn_contexts();
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<::UnityEngine::Transform*>& dyn_xfrms();
    // Get instance field reference: public VoiceModEnableSwitch SwitchTarget
    [[deprecated("Use field access instead!")]] ::GlobalNamespace::VoiceModEnableSwitch*& dyn_SwitchTarget();
    ...
    [[deprecated("Use field access instead!")]] int& dyn_currentPreset();
