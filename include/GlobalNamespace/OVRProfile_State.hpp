...
namespace GlobalNamespace {
  ...
  // [ObsoleteAttribute] Offset: 589F64
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRProfile::State), 16 + sizeof(int)> __GlobalNamespace_OVRProfile_StateSizeCheck;
  static_assert(sizeof(OVRProfile::State) == 0x14);
}
