...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRInput::OVRControllerGamepadMac::AxisGPC), 16 + sizeof(int)> __GlobalNamespace_OVRInput_OVRControllerGamepadMac_AxisGPCSizeCheck;
  static_assert(sizeof(OVRInput::OVRControllerGamepadMac::AxisGPC) == 0x14);
}
