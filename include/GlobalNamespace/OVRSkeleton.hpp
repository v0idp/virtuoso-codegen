...
namespace GlobalNamespace {
  ...
  // [DefaultExecutionOrder] Offset: 58A160
  class OVRSkeleton : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRSkeleton::SkeletonType), 16 + sizeof(int)> __GlobalNamespace_OVRSkeleton_SkeletonTypeSizeCheck;
    static_assert(sizeof(OVRSkeleton::SkeletonType) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRSkeleton::SkeletonType) == 0x14);
