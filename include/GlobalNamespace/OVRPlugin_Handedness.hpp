...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::Handedness), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_HandednessSizeCheck;
  static_assert(sizeof(OVRPlugin::Handedness) == 0x14);
}
