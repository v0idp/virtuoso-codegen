...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_FixedFoveatedRenderingLevel), 16 + sizeof(int)> __GlobalNamespace_OVRManager_FixedFoveatedRenderingLevelSizeCheck;
  static_assert(sizeof(OVRManager_FixedFoveatedRenderingLevel) == 0x14);
}
