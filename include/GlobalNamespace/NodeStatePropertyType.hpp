...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NodeStatePropertyType), 16 + sizeof(int)> __GlobalNamespace_NodeStatePropertyTypeSizeCheck;
  static_assert(sizeof(NodeStatePropertyType) == 0x14);
}
