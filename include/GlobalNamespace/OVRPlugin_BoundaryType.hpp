...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::BoundaryType), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_BoundaryTypeSizeCheck;
  static_assert(sizeof(OVRPlugin::BoundaryType) == 0x14);
}
