...
NEED_NO_BOX(::GlobalNamespace::VoiceModEnableSwitch);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::VoiceModEnableSwitch*, "", "VoiceModEnableSwitch");
// Type namespace: 
namespace GlobalNamespace {
  // Size: 0x20
  #pragma pack(push, 1)
  // Autogenerated type: VoiceModEnableSwitch
...
// Il2CppName: SetActive
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::VoiceModEnableSwitch::*)(int)>(&GlobalNamespace::VoiceModEnableSwitch::SetActive)> {
