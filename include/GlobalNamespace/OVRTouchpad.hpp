...
namespace GlobalNamespace {
  ...
  class OVRTouchpad : public ::Il2CppObject {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRTouchpad::TouchEvent), 16 + sizeof(int)> __GlobalNamespace_OVRTouchpad_TouchEventSizeCheck;
    static_assert(sizeof(OVRTouchpad::TouchEvent) == 0x14);
