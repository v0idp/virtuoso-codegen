...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::OverlayShape), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_OverlayShapeSizeCheck;
  static_assert(sizeof(OVRPlugin::OverlayShape) == 0x14);
}
