...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_MrcActivationMode), 16 + sizeof(int)> __GlobalNamespace_OVRManager_MrcActivationModeSizeCheck;
  static_assert(sizeof(OVRManager_MrcActivationMode) == 0x14);
}
