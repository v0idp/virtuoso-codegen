...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlatformMenu::eBackButtonAction), 16 + sizeof(int)> __GlobalNamespace_OVRPlatformMenu_eBackButtonActionSizeCheck;
  static_assert(sizeof(OVRPlatformMenu::eBackButtonAction) == 0x14);
}
