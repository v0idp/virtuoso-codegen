...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::Media::PlatformCameraMode), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_Media_PlatformCameraModeSizeCheck;
  static_assert(sizeof(OVRPlugin::Media::PlatformCameraMode) == 0x14);
}
