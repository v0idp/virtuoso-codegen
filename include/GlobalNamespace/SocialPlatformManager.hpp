...
namespace GlobalNamespace {
  ...
  class SocialPlatformManager : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(SocialPlatformManager::State), 16 + sizeof(int)> __GlobalNamespace_SocialPlatformManager_StateSizeCheck;
    static_assert(sizeof(SocialPlatformManager::State) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::SocialPlatformManager::State) == 0x14);
