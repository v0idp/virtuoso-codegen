...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::InsightPassthroughColorMapType), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_InsightPassthroughColorMapTypeSizeCheck;
  static_assert(sizeof(OVRPlugin::InsightPassthroughColorMapType) == 0x14);
}
