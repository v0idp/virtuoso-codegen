...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::SystemRegion), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_SystemRegionSizeCheck;
  static_assert(sizeof(OVRPlugin::SystemRegion) == 0x14);
}
