...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::BlendFactor), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_BlendFactorSizeCheck;
  static_assert(sizeof(OVRPlugin::BlendFactor) == 0x14);
}
