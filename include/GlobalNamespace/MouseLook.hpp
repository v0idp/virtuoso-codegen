...
namespace GlobalNamespace {
  ...
  // [AddComponentMenu] Offset: 5EA43C
  class MouseLook : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(MouseLook::RotationAxes), 16 + sizeof(int)> __GlobalNamespace_MouseLook_RotationAxesSizeCheck;
    static_assert(sizeof(MouseLook::RotationAxes) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::MouseLook::RotationAxes) == 0x14);
