...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ovrAvatarMaterialLayerSampleMode), 16 + sizeof(int)> __GlobalNamespace_ovrAvatarMaterialLayerSampleModeSizeCheck;
  static_assert(sizeof(ovrAvatarMaterialLayerSampleMode) == 0x14);
}
