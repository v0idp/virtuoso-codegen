...
namespace GlobalNamespace {
  ...
  class OVRMixedRealityCaptureTest : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRMixedRealityCaptureTest::CameraMode), 16 + sizeof(int)> __GlobalNamespace_OVRMixedRealityCaptureTest_CameraModeSizeCheck;
    static_assert(sizeof(OVRMixedRealityCaptureTest::CameraMode) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRMixedRealityCaptureTest::CameraMode) == 0x14);
