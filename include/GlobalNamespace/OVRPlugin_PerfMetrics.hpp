...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::PerfMetrics), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_PerfMetricsSizeCheck;
  static_assert(sizeof(OVRPlugin::PerfMetrics) == 0x14);
}
