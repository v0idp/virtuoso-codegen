...
namespace GlobalNamespace {
  ...
  // [DefaultExecutionOrder] Offset: 58A05C
  class OVRMesh : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRMesh::MeshType), 16 + sizeof(int)> __GlobalNamespace_OVRMesh_MeshTypeSizeCheck;
    static_assert(sizeof(OVRMesh::MeshType) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRMesh::MeshType) == 0x14);
