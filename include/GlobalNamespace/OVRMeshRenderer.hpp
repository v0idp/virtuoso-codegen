...
namespace GlobalNamespace {
  ...
  class OVRMeshRenderer : public ::UnityEngine::MonoBehaviour {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRMeshRenderer::ConfidenceBehavior), 16 + sizeof(int)> __GlobalNamespace_OVRMeshRenderer_ConfidenceBehaviorSizeCheck;
    static_assert(sizeof(OVRMeshRenderer::ConfidenceBehavior) == 0x14);
    // Size: 0x14
    #pragma pack(push, 1)
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRMeshRenderer::SystemGestureBehavior), 16 + sizeof(int)> __GlobalNamespace_OVRMeshRenderer_SystemGestureBehaviorSizeCheck;
    static_assert(sizeof(OVRMeshRenderer::SystemGestureBehavior) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRMeshRenderer::ConfidenceBehavior) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRMeshRenderer::SystemGestureBehavior) == 0x14);
