...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::CameraDeviceDepthSensingMode), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_CameraDeviceDepthSensingModeSizeCheck;
  static_assert(sizeof(OVRPlugin::CameraDeviceDepthSensingMode) == 0x14);
}
