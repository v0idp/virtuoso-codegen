...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::CameraDeviceDepthQuality), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_CameraDeviceDepthQualitySizeCheck;
  static_assert(sizeof(OVRPlugin::CameraDeviceDepthQuality) == 0x14);
}
