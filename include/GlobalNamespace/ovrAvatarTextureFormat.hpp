...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ovrAvatarTextureFormat), 16 + sizeof(int)> __GlobalNamespace_ovrAvatarTextureFormatSizeCheck;
  static_assert(sizeof(ovrAvatarTextureFormat) == 0x14);
}
