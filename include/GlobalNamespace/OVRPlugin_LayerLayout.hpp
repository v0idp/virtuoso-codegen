...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::LayerLayout), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_LayerLayoutSizeCheck;
  static_assert(sizeof(OVRPlugin::LayerLayout) == 0x14);
}
