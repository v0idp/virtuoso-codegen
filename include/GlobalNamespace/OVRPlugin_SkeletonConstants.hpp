...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::SkeletonConstants), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_SkeletonConstantsSizeCheck;
  static_assert(sizeof(OVRPlugin::SkeletonConstants) == 0x14);
}
