...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRLipSync::AudioDataType), 16 + sizeof(int)> __GlobalNamespace_OVRLipSync_AudioDataTypeSizeCheck;
  static_assert(sizeof(OVRLipSync::AudioDataType) == 0x14);
}
