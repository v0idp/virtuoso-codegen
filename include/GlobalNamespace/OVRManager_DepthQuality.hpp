...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_DepthQuality), 16 + sizeof(int)> __GlobalNamespace_OVRManager_DepthQualitySizeCheck;
  static_assert(sizeof(OVRManager_DepthQuality) == 0x14);
}
