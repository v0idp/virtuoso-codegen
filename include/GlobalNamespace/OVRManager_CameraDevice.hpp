...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRManager_CameraDevice), 16 + sizeof(int)> __GlobalNamespace_OVRManager_CameraDeviceSizeCheck;
  static_assert(sizeof(OVRManager_CameraDevice) == 0x14);
}
