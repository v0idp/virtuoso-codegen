...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::LayerFlags), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_LayerFlagsSizeCheck;
  static_assert(sizeof(OVRPlugin::LayerFlags) == 0x14);
}
