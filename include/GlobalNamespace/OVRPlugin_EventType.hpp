...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::EventType), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_EventTypeSizeCheck;
  static_assert(sizeof(OVRPlugin::EventType) == 0x14);
}
