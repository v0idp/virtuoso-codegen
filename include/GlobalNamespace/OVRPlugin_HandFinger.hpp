...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::HandFinger), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_HandFingerSizeCheck;
  static_assert(sizeof(OVRPlugin::HandFinger) == 0x14);
}
