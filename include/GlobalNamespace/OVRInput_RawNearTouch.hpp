...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRInput::RawNearTouch), 16 + sizeof(int)> __GlobalNamespace_OVRInput_RawNearTouchSizeCheck;
  static_assert(sizeof(OVRInput::RawNearTouch) == 0x14);
}
