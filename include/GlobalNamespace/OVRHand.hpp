...
namespace GlobalNamespace {
  ...
  // [DefaultExecutionOrder] Offset: 58A038
  class OVRHand : public ::UnityEngine::MonoBehaviour/*, public ::GlobalNamespace::OVRSkeleton::IOVRSkeletonDataProvider, public ::GlobalNamespace::OVRSkeletonRenderer::IOVRSkeletonRendererDataProvider, public ::GlobalNamespace::OVRMesh::IOVRMeshDataProvider, public ::GlobalNamespace::OVRMeshRenderer::IOVRMeshRendererDataProvider*/ {
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRHand::Hand), 16 + sizeof(int)> __GlobalNamespace_OVRHand_HandSizeCheck;
    static_assert(sizeof(OVRHand::Hand) == 0x14);
    // Size: 0x14
    #pragma pack(push, 1)
    ...
    #pragma pack(pop)
    static check_size<sizeof(OVRHand::TrackingConfidence), 16 + sizeof(int)> __GlobalNamespace_OVRHand_TrackingConfidenceSizeCheck;
    static_assert(sizeof(OVRHand::TrackingConfidence) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRHand::Hand) == 0x14);
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OVRHand::TrackingConfidence) == 0x14);
