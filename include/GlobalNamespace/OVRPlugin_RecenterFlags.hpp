...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPlugin::RecenterFlags), 16 + sizeof(int)> __GlobalNamespace_OVRPlugin_RecenterFlagsSizeCheck;
  static_assert(sizeof(OVRPlugin::RecenterFlags) == 0x14);
}
