...
namespace Mono::Security::Interface {
  ...
  class Alert : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::Mono::Security::Interface::AlertLevel) == 0x11);
    // private Mono.Security.Interface.AlertDescription description
    // Size: 0x11
    // Offset: 0x11
    ::Mono::Security::Interface::AlertDescription description;
    // Field size check
    static_assert(sizeof(::Mono::Security::Interface::AlertDescription) == 0x11);
    public:
  ...
  static_assert(sizeof(Alert) == 0x22);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
