...
namespace Mono::Security::Interface {
  ...
  #pragma pack(pop)
  static check_size<sizeof(AlertDescription), 16 + sizeof(uint8_t)> __Mono_Security_Interface_AlertDescriptionSizeCheck;
  static_assert(sizeof(AlertDescription) == 0x11);
}
