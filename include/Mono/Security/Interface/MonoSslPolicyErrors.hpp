...
namespace Mono::Security::Interface {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MonoSslPolicyErrors), 16 + sizeof(int)> __Mono_Security_Interface_MonoSslPolicyErrorsSizeCheck;
  static_assert(sizeof(MonoSslPolicyErrors) == 0x14);
}
