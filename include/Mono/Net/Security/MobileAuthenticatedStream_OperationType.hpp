...
namespace Mono::Net::Security {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MobileAuthenticatedStream::OperationType), 16 + sizeof(int)> __Mono_Net_Security_MobileAuthenticatedStream_OperationTypeSizeCheck;
  static_assert(sizeof(MobileAuthenticatedStream::OperationType) == 0x14);
}
