...
namespace Mono::Unity {
  ...
  #pragma pack(pop)
  static check_size<sizeof(UnityTls::unitytls_x509verify_result), 16 + sizeof(uint)> __Mono_Unity_UnityTls_unitytls_x509verify_resultSizeCheck;
  static_assert(sizeof(UnityTls::unitytls_x509verify_result) == 0x14);
}
