...
namespace Mono::Unity {
  ...
  #pragma pack(pop)
  static check_size<sizeof(UnityTls::unitytls_ciphersuite), 16 + sizeof(uint)> __Mono_Unity_UnityTls_unitytls_ciphersuiteSizeCheck;
  static_assert(sizeof(UnityTls::unitytls_ciphersuite) == 0x14);
}
