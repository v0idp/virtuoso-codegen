...
namespace Mono::Unity {
  ...
  #pragma pack(pop)
  static check_size<sizeof(UnityTls::unitytls_protocol), 16 + sizeof(uint)> __Mono_Unity_UnityTls_unitytls_protocolSizeCheck;
  static_assert(sizeof(UnityTls::unitytls_protocol) == 0x14);
}
