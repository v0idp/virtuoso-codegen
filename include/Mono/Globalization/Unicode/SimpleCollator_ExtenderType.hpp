...
namespace Mono::Globalization::Unicode {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SimpleCollator::ExtenderType), 16 + sizeof(int)> __Mono_Globalization_Unicode_SimpleCollator_ExtenderTypeSizeCheck;
  static_assert(sizeof(SimpleCollator::ExtenderType) == 0x14);
}
